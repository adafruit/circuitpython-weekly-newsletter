---
layout: post
title: "Pi 5 Manufacturing Soars, Thea Flowers New OSHWA President and Much More!"
...
Welcome to the latest Python on Microcontrollers newsletter! A frozen northern hemisphere is still busy when it comes to Python and hardware as witnessed by all the happenings this week. COngratulations to Thea "Stargirl" Flowers, Pythonista/CircuitPythonista for heading OSHWA! Lots of Pi news as usual, and more on editing your code in a web browser: an open source solution for CircuitPython and a crippled unless you pay version from Arduino. There is so much more happening, check it all out in this week's edition. - *Anne Barela, Ed.*
...
[![Python 3.13.0 alpha 3 is now available](../assets/20240122/20240122psf.jpg)](https://www.python.org/)

Python 3.13.0 alpha 3 is now available - [Python Insider Blog](https://pythoninsider.blogspot.com/).

Announcing Python Software Foundation Fellow Members for Q3 2023 - [Python.org](https://pyfound.blogspot.com/2024/01/announcing-python-software-foundation.html).
...
John Park’s CircuitPython Parsec this week is on IP Ping - [Adafruit Blog](https://blog.adafruit.com/2024/01/19/john-parks-circuitpython-parsec-ip-ping-adafruit-circuitpython/) and [YouTube](https://youtu.be/8m7xr2eGxEk).
...
[![Damien George](../assets/20240122/20240122dev.jpg)](https://devm.io/python/micropython-python-microcontroller-001)

An interview with Damien George, MicroPython's creator: "MicroPython: A familiar high-level language combined with the ability to directly utilise a microcontroller” - [devmio](https://devm.io/python/micropython-python-microcontroller-001).

[![Pidog](../assets/20240122/20240122pidog.jpg)](https://www.sunfounder.com/products/sunfounder-pidog-robot-dog-kit-for-raspberry-pi?ref=HoiTVi03)

The SunFounder PiDog robot dog kit for Raspberry Pi is out and can be programmed in Python - [SunFounder](https://www.sunfounder.com/products/sunfounder-pidog-robot-dog-kit-for-raspberry-pi?ref=HoiTVi03).

[![Marble Clock](../assets/20240122/20240122clock.jpg)](https://www.hackster.io/xpienet/dual-spiral-marble-clock-3aacf8)

A dual spiral rolling ball clock controlled by a Raspberry Pi Pico using a combination of 3D printed and hand made parts in metal, acrylic & wood, programmed in MicroPython - [hackster.io](https://www.hackster.io/xpienet/dual-spiral-marble-clock-3aacf8) and [YouTube](https://youtu.be/CGMtlKLALP4).
...
[![Tracking the International Space Station with a Pimoroni Badger 2040W and MicroPython](../assets/20240122/20240122simon.jpg)](https://twitter.com/simon_prickett/status/1747568138529681468)

Tracking the International Space Station with a Pimoroni Badger 2040W and MicroPython - [X Broadcast Video](https://twitter.com/simon_prickett/status/1747568138529681468).
...
[![RigExpert ZeroII board](../assets/20240122/20240122ham.jpg)](https://twitter.com/VE3NKL/status/1747298966478172317)

> "Ham radio: I played with RigExpert ZeroII board on the weekend... Started with Arduino Nano but then switched to Raspberry Pi Pico W. Since I could only find C libraries for the board, I decided to write my own MicroPython module to communicate with the device. So far so good" - [X](https://twitter.com/VE3NKL/status/1747298966478172317).

See the code - [GitHub](https://github.com/ve3nkl/RigExpertZeroII).

[![RP2040 PCB: Design](../assets/20240122/20240122rp.jpg)](https://community.element14.com/challenges-projects/element14-presents/project-videos/w/documents/28387/rp2040-pcb-design-turn-on-and-debug---how-hard-could-it-be----episode-638?CMP=SOM-TWITTER-PRG-E14PRESENTS-EP638-IMAGEPOST-COMM)

RP2040 PCB: Design, Turn-On, and Debug - How Hard Could It Be? -- Episode-638 - [Element14](https://community.element14.com/challenges-projects/element14-presents/project-videos/w/documents/28387/rp2040-pcb-design-turn-on-and-debug---how-hard-could-it-be----episode-638?CMP=SOM-TWITTER-PRG-E14PRESENTS-EP638-IMAGEPOST-COMM) and [YouTube](https://youtu.be/LUEgJpy-Un4).
