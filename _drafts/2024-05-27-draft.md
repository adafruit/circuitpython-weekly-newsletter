---
layout: post
title: "Raspberry IPO Set for June, New CircuitPython Releases and Much More!"
...
Sony is installing a dedicated Raspberry Pi 5 assembly line in Japan - [eeNews](https://www.eenewseurope.com/en/sony-plans-dedicated-raspberry-pi-5-line-ahead-of-ipo/).
...
Utilizing technology from Groq and Meta, this project aims to replace traditional response mechanisms on a maker site with a much faster and efficient alternative using an RP2040 connected to Groq's cloud services with MicroPython - [WIZnet Makers](https://maker.wiznet.io/simons/projects/how-to-get-an-answer-to-rp2040-in-3-seconds-with-groq/) and [GitHub](https://github.com/wiznetmaker/Groq_W5100s_EVB_PICO).
...
[![Deep Dive](../assets/20240527/20240527deepdive.jpg)](https://www.youtube.com/live/cduzrrXZj8c)

[Last Friday](https://www.youtube.com/live/cduzrrXZj8c), Scott streamed work on SVD files and builds.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20240527/20240527jp.jpg)](https://www.youtube.com/playlist?list=PLjF7R1fz_OOWFqZfqW9jlvQSIUmwn9lWr)
...
Regular MicroPython contributor Jos Verlinde (@josverl) released his Python application, mpflash. It’s a command-line utility to assist in deploying MicroPython firmware to devices. It can list connected boards, detect and download the appropriate image and flash it to a device - [GitHub](https://github.com/Josverl/micropython-stubber/tree/main/src/mpflash) via [MicroPython May 2024 Meetup News Roundup](https://melbournemicropythonmeetup.github.io/May-2024-Meetup/).
...
Ashish built a speech recognition project using a Raspberry Pi Pico and CircuitPython. It samples audio from a mic, runs a TinyML model, and tries to identify a spoken word - [X](https://x.com/patilsaheb/status/1793000847418294641) and [GitHub](https://github.com/code2k13/pipico_speech_recognition).
...
> "Running a few Midjourney images on an Adafruit Sharp Memory Display using a Raspberry Pi Pico W and CircuitPython. The display looks excellent to the eyes *(editor note: better than the GIF I posted)*, and better than what the iPhone camera captures - [X](https://x.com/CosminDolha/status/1793404150786523200).
...
The signal status is determined using XBee's MicroPython, and the host XBee receives the signal, measures the time, and displays it on the speed gun meter in speed gun format." - [X](https://x.com/kstakshin/status/1793198595337850998) (Japanese).
...
[![CircuitPython asyncio](../assets/20240527/20240527coin.jpg)](https://gitlab.com/bradanlane_cp/asynchronous-io)

An example for using `asyncio` with input/output in CircuitPython by Bradán Lane - [GitLab](https://gitlab.com/bradanlane_cp/asynchronous-io).
...
[![Espressif ESP32-S3-EYE](../assets/20240527/20240527esp.jpg)](https://www.adafruit.com/product/5955)

Espressif ESP32-S3-EYE, an ESP32-S3 camera board - [Adafruit](https://www.adafruit.com/product/5955).
...
- [Ai Thinker ESP32-CAM](https://circuitpython.org/board/ai-thinker-esp32-cam/)
- [LOLIN32](https://circuitpython.org/board/wemos_lolin32_lite/)
- [ESP8684-DevKitC-2-N4](https://circuitpython.org/board/espressif_esp8684_devkitc_02_n4/)
- [ESP32-WRover Cam Dev Board](https://circuitpython.org/board/esp32-wrover-dev-cam/)
- [Bradán Lane STUDIO Explorer Badge](https://circuitpython.org/board/bradanlanestudio_explorer_rp2040/)
...
Here's this week's new CircuitPython libraries:
  ...
  * [CDarius/CircuitPython_AXP2101](https://github.com/CDarius/CircuitPython_AXP2101)
...
[20240523](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.

[20240524](https://github.com/adafruit/CircuitPython_Community_Bundle/releases/latest) is the latest CircuitPython Community library bundle.
...
[3,919 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,567 THANKS](../assets/20240527/39kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 38,567 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
