...
Previously we posted about the SESC Workshop, São Paulo, Brazil happening this month. If you'd like to see their CircuitPython code for things like NeoPixel games, the code is available - [GitHub](https://github.com/djairjr/oficina_CircuitPython).
