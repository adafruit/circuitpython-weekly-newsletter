...
Chip Shortage is the latest video series from Adafruit. Ladyada discusses the current chip shortage in the electronics industry with focus on a specific product - [Adafruit Blog](https://blog.adafruit.com/2022/04/21/chip-shortage-a-new-video-series-by-adafruit-chipshortage-adafruit-adafruit/), this week's video [YouTube](https://youtu.be/vGjQcPUfBdM) and [YouTube Playlist](https://www.youtube.com/playlist?list=PLjF7R1fz_OOX6EyjN3BYud1VHIqnDyvm_).
