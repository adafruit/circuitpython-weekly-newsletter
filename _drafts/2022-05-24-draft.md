...
Thanks to https://github.com/sekigon-gonnoc/Pico-PIO-USB, Raspberry Pi RP2040 microcontrollers can have additional USB ports through the use of the chip's PIO. RP2040 runs as device on native USB and host on 2 GPIOs, both managed by TinyUSB - [Twitter](https://twitter.com/tinyusb/status/1526126928989913089).
...
The CircuitPython Show is off this week.  Last week featured Adafruit's Liz Clark and next week Pierre Constantineau joins the show to talk about mechanical keyboards and CircuitPython. – [Show List](https://circuitpyshow.com/episodes).
...
[![sh Package](../assets/20220524/20220524sh.jpg)]([url](https://twitter.com/driscollis/status/1527662554352263169))
