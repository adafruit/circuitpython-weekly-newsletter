...
## Python snakes its way to the new Texas Instruments TI-84 Plus CE Python Graphing Calculator running CircuitPython!
...
The new TI-84 Plus CE Python Graphing Calculator by Texas Instruments runs CircuitPython! 
...
Mix Both MicroPython & CircuitPython Code In The Same File On A Raspberry Pi Pico With Blinka - [YouTube](https://www.youtube.com/watch?v=l254lxm78I4)

## Feature

[![title](../assets/20210525/20210525-name.jpg)](url)

text - [site](url)

## Adafruit Squeezes the Power of the RP2040 Into a USB key

[![Adafruit Squeezes the Power of the RP2040 Into a USB key](../assets/20210525/20210525toms.jpg)](https://www.tomshardware.com/news/adafruit-rp2040-trinkey-prototype)

Tom's Hardware reviews the Adafruit QT 2040 Trinkey

> We've wanted to have something that plugs into a USB A port and provides a QT port for a while. But since we want it to support any and all QT boards, we need more RAM and storage than the SAMD21 can provide... The QT 2040 Trinkey has the same basic layout as a Stemma QT components, such as the BME680, and can be mounted on top of the QT 2040 Trinkey for a neat form factor.

More - [Tom's Hardware](https://www.tomshardware.com/news/adafruit-rp2040-trinkey-prototype)
...
[![Deep Dive with Scott](../assets/20210525/20210525deepdive.jpg)](link)
