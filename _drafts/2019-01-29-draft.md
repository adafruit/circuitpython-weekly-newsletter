...
Pages 96 & 97 an delightful article on making your own light painting glove by Sophy Wong using CircuitPython.
...
ALL ABOARD! The SparkFun RedBoard Turbo - SAMD21 Development Board is the latest board from SparkFun that supports CircuitPython, check out the [product page](https://www.sparkfun.com/products/14812), [video](https://youtu.be/ahuEUC8uQ2k), and [GitHub](https://github.com/sparkfun/RedBoard_Turbo).
...
Scott's [working on](https://twitter.com/tannewt/status/1088724885294051328?s=11) [displaying text](https://twitter.com/tannewt/status/1088990802468982784) right from the terminal.
