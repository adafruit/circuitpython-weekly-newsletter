...
[![nRF52840 based Metro Express]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)
...
[![ESP32 Breakout]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)
...
[![ATECC608A]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)
...
[![ItsyBitsy nRF52480]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)

ItsyBitsy nRF52480 runs CircuitPython. Thinking of calling all these nRF boards [NARF](https://youtu.be/Y-Q-aeF5UPk).

[![Terminal]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/tannewt/status/1088990802468982784)
