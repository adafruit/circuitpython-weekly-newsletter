...
Welcome to the latest Python on Microcontrollers newsletter! Hacktober Welcome to Autumn (in the North). Hacktoberfest is nearly here where everyone can contribute to open source projects. Eben Upton gives a new interview post chip shortage and PyScript gets a complete rewrite among the news this week. Don't forget to get started on your Halloween projects, one of the most project prolific times all year - *Anne Barela, Ed.*
...
As in previous years, CircuitPython will be participating in Hacktoberfest, marking some Pull Requests as Hacktober eligible. Keep an eye on the Adafruit Blog and Social Media for details as October approaches - [Adafruit Blog](https://blog.adafruit.com/2023/09/22/participate-in-hacktoberfest-2023-circuitpython-hacktoberfest-github-digitalocean/).
