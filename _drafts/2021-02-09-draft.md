...
Welcome to a special issue of the latest Python for Microcontrollers newsletter! This issue focuses mainly on the new Raspberry Pi Pico and it's RP2040 chip. Many people are using MicroPython and CircuitPython to program this new silicon. Several articles with the developers kick off today's coverage.
