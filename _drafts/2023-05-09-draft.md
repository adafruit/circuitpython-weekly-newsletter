...
Alan has created a project to display weather information in the form of Picasso-like images. Through web crawling the Python code asks GPT to make a simple story about the weather, sends the story to DALL-E 2 to obtain a Picasso-like image of the current weather, then transmits the image to a Raspberry Pi Pico through Ethernet and outputs it to an LCD - [hackster.io project](https://www.hackster.io/alan43/wow-enjoy-the-current-weather-with-picasso-s-painting-1e01f4), [article](https://www.hackster.io/news/chatgpt-and-dall-e-make-weather-reports-interesting-13206593e617), [YouTube](https://youtu.be/PKeusv8m2aM) and [GitHub](https://github.com/Alan-Shin/W5100S-Pico-GPT-API).
