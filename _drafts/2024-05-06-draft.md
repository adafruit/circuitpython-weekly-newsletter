---
layout: post
title: "MicroPython Turns 11, Arduino vs. CircuitPython and Much More!"
...
Build Wireless Products Faster with Zephyr and MicroPython - Ryan Erickson, Ezurio - [YouTube](https://www.youtube.com/watch?v=Y2v6Eh8X8iA).
...
Looking to use a Raspberry Pi in your project? Instead of a single board computer, you might look at a microcontroller. Besides there being no operating system to maintain, read about other advantages - [Slashgear](https://www.slashgear.com/1568342/what-arduino-can-do-that-raspberry-pi-cant/).
...
[![The PSF's 2023 Annual Impact Report](../assets/20240506/20240506report.jpg)](url)

The Python Software Foundation (PSF) has captured some of the key numbers, details, and information on the last year in their latest Annual Impact Report - [Report Slides](https://www.python.org/psf/annual-report/2023/) and [Python Software Foundation](https://pyfound.blogspot.com/2024/05/the-psfs-2023-annual-impact-report-is.html).
...
[![Deep Dive](../assets/20240506/20240506deepdive.jpg)](https://www.youtube.com/watch?v=3lfj_O88Egg)

[Last Friday](https://www.youtube.com/watch?v=3lfj_O88Egg), Scott streamed work on Espressif ESP Bluetooth Low Energy (BLE) debugging.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20240506/20240506jp.jpg)](https://blog.adafruit.com/2024/04/26/john-parks-circuitpython-parsec-circup-code-examples-adafruit-circuitpython/)

John Park’s CircuitPython Parsec this week is on circup code examples - [Adafruit Blog](https://blog.adafruit.com/2024/04/26/john-parks-circuitpython-parsec-circup-code-examples-adafruit-circuitpython/) and [YouTube](https://youtu.be/J6-NYLCfHSE).
...
[![4-way NVMe RAID](../assets/20240506/20240506raid.jpg)](https://www.jeffgeerling.com/blog/2024/4-way-nvme-raid-comes-raspberry-pi-5)

With the Raspberry Pi 5's exposed PCI Express connector comes many new possibilities. Jeff Geerling this time tests and documents the [Geekwork X1011](https://geekworm.com/products/x1011), which puts four NVMe SSDs under a Raspberry Pi - [Jeff Geerling](https://www.jeffgeerling.com/blog/2024/4-way-nvme-raid-comes-raspberry-pi-5) and [Tom's Hardware](https://www.tomshardware.com/raspberry-pi/add-on-board-lets-you-use-four-nvme-ssds-at-once-with-raspberry-pi-5).
...
[![Browser-based IDE for CircuitPython](../assets/20240506/20240506trs.jpg)](https://octodon.social/@trevorflowers@machines.social/112355353414989159)
...
A Zoom call status monitor with a Raspberry Pi Pico and MicroPython - [X](https://twitter.com/PaterPracticus/status/1785728603612680489), [GitHub](https://github.com/PaterPracticus/Video-call_Interruptibility_Status_Indicator) and [YouTube](https://www.youtube.com/watch?v=Ch0FHyCTUvo).
...
> "It was super easy to get LoRa communication working with CircuitPython on current and experimental nuggets. So far, the maximum range has been 4 miles!" - [Mastodon](https://infosec.exchange/@skickar/112367132923227583).

[![MIDI light controller](../assets/20240506/20240506midi.gif)](https://twitter.com/Secoh2000/status/1784783585674752186)
...
Where is the ISS, Raspberry Pi and Python version - [WhiskeyTangoHotel](http://www.whiskeytangohotel.com/2024/04/where-is-iss-rasberry-pi-version.html).
...
- [Spotpear ESP32C3 LCD 1.44](https://circuitpython.org/board/spotpear_esp32c3_lcd_1_44/)
...
[20240503](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[3,907 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![39,181 THANKS](../assets/20240506/39kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 39,181 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
