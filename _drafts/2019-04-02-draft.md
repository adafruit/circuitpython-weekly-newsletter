...
[![CircuitPython 4.0.0 beta 6]({{ "/assets/" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2019/03/29/circuitpython-4-0-0-beta-6-released/)
...
[![Hack Chat]({{ "/assets/" | absolute_url }}){:width="550px"}](https://hackaday.io/event/164062-python-and-the-internet-of-things-hack-chat)
...
[![MSGEQ7]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/LapPe2nKFLk)
...
[![Jetson Nano BLINKA]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.androidauthority.com/jetson-nano-review-969318/)
...
[![Avengers: Endgame]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/ueeoy11MbiI)

Avengers: Endgame Posters on an Adafruit PyPortal, made with CircuitPython! - [YouTube](https://youtu.be/ueeoy11MbiI).

[![SparkFun]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.sparkfun.com/products/15110)
...
[![Asana]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.instagram.com/p/Bvjvo9QHGJF/)
...
[![IBM]({{ "/assets/" | absolute_url }}){:width="550px"}](https://twitter.com/ronhiltz/status/1112069328415981568)
...
[![MP BDAY]({{ "/assets/" | absolute_url }}){:width="550px"}](https://gotocon.com/dl/goto-amsterdam-2016/slides/DamienGeorge_MicroPythonAndTheInternetOfThings.pdf)
...
[![micromag]({{ "/assets/" | absolute_url }}){:width="550px"}](https://micromag.cc/issuefour/)
...
[![xkcd]({{ "/assets/" | absolute_url }}){:width="550px"}](https://snarky.ca/deconstructing-xkcd-com-1987/)
...
[![STEP Award]({{ "/assets/" | absolute_url }}){:width="550px"}](http://www.themanufacturinginstitute.org/Initiatives/Women-in-Manufacturing/2019-Honorees.aspx)
...
[![Mu]({{ "/assets/" | absolute_url }}){:width="550px"}](http://madewith.mu/mu/users/2019/03/25/alpha1.html)
...
[![AirLift METROS!]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)

[![AirLift METROS!]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)

AirLift METROS!

[![AirLift FEATHER]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)

[![AirLift FEATHER]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)

AirLift FEATHER!

[![PyBadge]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)
...
[![Alarm clock]({{ "/assets/" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/pyportal-alarm-clock)
...
[![11,451]({{ "/assets/" | absolute_url }}){:width="550px"}](https://adafru.it/discord)
