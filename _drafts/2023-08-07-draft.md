...
Welcome to the latest Python on Microcontrollers newsletter! With the start of August, conferences and back-to-school is in full swing. We feature a number of events of interest to Python on hardware folks.  *- Ed.*
...
John Park’s CircuitPython Parsec this week is on light detection - [Adafruit Blog](https://blog.adafruit.com/2023/08/04/john-parks-circuitpython-parsec-circuit-playground-light-detect/), [GitHub](https://github.com/jedgarpark/parsec) and [YouTube](link).
