---
layout: post
title: "code.circuitpython.org, The Best Python Cheat Sheet and much more!"
...
Welcome to the latest Python on Microcontrollers newsletter! Ah, summertime (in the Northern Hemisphere), Open Sauce and Teardown have been happening this week and more events to come. Students tossing their homework and graduation caps. And free time to work on making some cool hardware. Fortunately Python on small devices makes it so easy to prototype and iterate. Check out the latest issue (and stay cool). - *Anne Barela, Editor*
...
[![Lock control](../assets/20240624/20240624lock.gif)](https://x.com/alistairjcbrown/status/1803930523783385339)

Controlling a door latch using an ESP32 running MicroPython - [X](https://x.com/alistairjcbrown/status/1803930523783385339).
...
[![IoT light bulb](../assets/20240624/20240624bulb.jpg)](https://x.com/CoolApps45/status/1803900584661258663)

> "I got the Raspberry Pi Pico W to communicate with the IoT light bulb I have around (ported some core stuff from the JavaScript library to MicroPython). Communication is done over UDP. Encryption is so poor that I question why it's even there in the first place" - [X](https://x.com/CoolApps45/status/1803900584661258663).
...
- [Arduino Nano 33 BLE Rev2 / Nano 33 BLE Sense Rev2](https://circuitpython.org/board/arduino_nano_33_ble_rev2/)
