...
Kevin McAleer made a cute robot arm with a camera on the end. It uses inverse kinematics to keep the camera pointing forward. dafruit CircuitPython for Linux is used running on a Raspberry Pi 5 - [Mastodon](https://mastodon.social/@kevsmac/112226140573188214) and [Twitter](https://twitter.com/kevsmac/status/1776706503208046967).
