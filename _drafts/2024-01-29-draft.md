...
MacroPad by MCHilli is an Adafruit MacroPad script that allows one to manage macros via a [WebUI](https://mchilli.github.io/macropad/) - [GitHub](https://github.com/mchilli/macropad?tab=readme-ov-file).
