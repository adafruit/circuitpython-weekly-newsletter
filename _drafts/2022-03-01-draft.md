...
At the Saigon South International School (SSIS), two Sphero RVRs, two VEXRobotics games, two boards (a Raspberry Pi Pico and an Adafruit Metro M4 Express) running the same CircuitPython program.
