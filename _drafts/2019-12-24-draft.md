...
[![94](../assets/12242019/)](https://circuitpython.org/downloads)

There are over 94+ boards on circuitpython.org. Less than half of the board are from Adafruit, there are 40 Adafruit-made boards and 54+ from everyone else! This means there an entire ecosystem of boards out there from makers and companies around the world, all that run the open-source CircuitPython! - [circuitpython.org/downloads](https://circuitpython.org/downloads). 100 boards here we come!
...
[![Remote](../assets/12242019/)](https://learn.adafruit.com/circuit-playground-bluefruit-neopixel-animation-and-color-remote-control)
