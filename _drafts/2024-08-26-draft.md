...
Tutorial video and project that implement a basic user authentication system with Flask and MongoDB - [YouTube](https://youtu.be/evarMujBC88?si=mjEHEC3sBNC7aT6F) and [GitHub code](https://github.com/FoamyGuy/Flask_MongoDB_Basic_User_Authentication_Tutorial)
