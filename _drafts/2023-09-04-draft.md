...
Adafruit now has the Espressif ESP32-S3 talking to large "dot clock" displays like the 7 inch 800x480 display above. There will be a display driver board with the S3 soon alonng with a selection of displays including rectangular, circular, and square - [X, formerly Twitter](https://twitter.com/adafruit/status/1696925374100259012) and [YouTube](https://www.youtube.com/watch?v=uKouVzFcVxM).
