...
Welcome to the latest Python on Microcontrollers newsletter! So much is now happening in the Python on Hardware space! Novel ways to display in CircuitPython and MicroPython are out this week. The crop of projects is first class. And we hit 250 published newsletters (such a huge number!) Thanks amm for your  - *Anne Barela, Ed.*
...
You can see the latest video by Tim and all past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).
