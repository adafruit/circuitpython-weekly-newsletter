...
Arya Voronova provides an overview of MicroPython, it's capabilities and how its usefulness can be adictive - [Hackaday](https://hackaday.com/2024/07/11/embedded-python-micropython-is-amazing/).
...
Python meets JavaScript, Wasm with the magic of PythonMonkey - [TheNewStack]https://thenewstack.io/python-meets-javascript-wasm-with-the-magic-of-pythonmonkey/).
...
[![Raspberry Pi 5 cluster?](../assets/20240715/20240715-cluster.jpg)](https://www.raspberrypi.com/news/wanna-build-a-raspberry-pi-5-cluster/)
