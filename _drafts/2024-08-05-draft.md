---
layout: post
title: "CiricuitPython Day 2024, a MicroPython Computer and Much More!"
...
[![Python 3.13.0](../assets/20240805/20240805psf.jpg)](https://pythoninsider.blogspot.com/2024/08/python-3130-release-candidate-1-released.html)

The first release candidate for Python 3.13 is out, freezing features.  Developers are looking to complete the documentation and quash any reported bugs. There are many important features that have been added - [Python Blog](https://pythoninsider.blogspot.com/2024/08/python-3130-release-candidate-1-released.html).
...
An [Adafruit Matrix Portal](https://www.adafruit.com/product/4745) weather station using a [BME280 sensor](https://www.adafruit.com/product/2652) over I2C displayed on a [64x32 LED matrix](https://www.adafruit.com/product/2279) using CircuitPython - [X](https://x.com/Fr4nkFletcher/status/1819442963245944836) and [GitHub](https://github.com/Fr4nkFletcher/MatrixPortal_WeatherStation).
...
[20240729](https://github.com/adafruit/CircuitPython_Community_Bundle/releases/latest) is the latest CircuitPython Community library bundle.
...
[3.12.4](https://www.python.org/downloads/) is the latest Python release. The latest pre-release version is [3.13.0rc1](https://www.python.org/download/pre-releases/).

[3,977 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
