...
[![PyPortal]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.adafruit.com/pyportal)
...
[![Python Discord]({{ "/assets/" | absolute_url }}){:width="550px"}](https://discord.gg/djuFYQA)
...
[![Theramin]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/4ow5zfkgRMQ)
...
[![BMO]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/XS96F4ieopQ)
...
[![Analog Devices]({{ "/assets/" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/iot-temperature-logger-with-python-and-adafruit-io)
