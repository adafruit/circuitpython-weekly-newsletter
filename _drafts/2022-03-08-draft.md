...
Welcome to the latest Python on Microcontrollers newsletter! Events on the world stage are eclipsing work in Python. There are more in-person events happening and a focus on the people working on embedded Python. Keep an eye these trends. On to today's issue:
