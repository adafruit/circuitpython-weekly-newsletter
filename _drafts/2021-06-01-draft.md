...
Machine learning is a transformative tool that’s redefining how we build software — but up until now, it was only accessible to a small group of experts. At Adafruit, we think machine learning should be accessible to everyone, that’s why Adafruit partnered with Microsoft and their Lobe platform for an easy to use machine learning kit using the Adafruit Braincraft hardware for Raspberry Pi, to bring your machine learning ideas to life – [video](https://youtu.be/O6KdTTdioTY).

Ladaada appeared in the Microsoft Build keynote with the Kevin Scott, CTO of Microsoft - [YouTube](https://youtu.be/ML0s-T55VPA) and  more info on the [Adafruit Blog](https://blog.adafruit.com/2021/05/29/bakery-machine-learning-on-the-edge-with-adafruit-microsoft-lobe/)
