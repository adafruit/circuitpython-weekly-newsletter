...
Accurate frequency measurement using a Pi Pico RP2040 is relatively easy with C but with MicroPython it is more of a challenge. This article shows how to do so with MicroPython - [iosoft Blog](https://iosoft.blog/2023/08/21/picofreq_python/), [GitHub](https://github.com/jbentham/picofreq) and [Hackaday](https://hackaday.com/2023/08/26/accurate-cycle-counting-on-rp2040-micropython/).
