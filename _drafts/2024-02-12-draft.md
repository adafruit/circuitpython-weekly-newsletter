...
Gameplay consists of several mini games played using the washing machine panel, the PiDP11 (Raspberry Pi powered) computer, and other items. Raspberry Pi acts as the central game "server" and communicates with other devices using a serial protocol. The controllers are a mix of Raspberry Pi Pico and Arduino Nano. Most of the code written in C and C++ with some CircuitPython - [X](https://twitter.com/DoomHammerNG/status/1751913265263689752).
