...
Welcome to the latest Python on Microcontrollers newsletter! With Apple Vision Pro garnering media attention, finding Python on hardware gems is that much harder. But we still strive to find all the week's best news. You can help: send in your news, projects, etc. to cpnews(at)adafruit(dot)com for consideration. Happy Valentine's Day! - *Anne Barela, Ed.*
