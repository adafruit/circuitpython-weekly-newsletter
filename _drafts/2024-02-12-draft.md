...
Code can fail. Learning how it might fail and what to do can be important, especially if the device running the code is remote. Adafruit Playground author fede2 looks at how CVircuitPython detects failures and how t devise a programmatic method for recovery - [Adafruit Playground](https://adafruit-playground.com/u/fede2/pages/failing-with-circuitpython).
