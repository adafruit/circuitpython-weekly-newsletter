...
CircuitPython 6.2.0 Beta 2 was recently released. This is the third beta release of CircuitPython 6.2.0. This release, 6.2.0-beta.2, contains fixes and improvements, most notably for RP2040 and ESP32-S2 based boards - [Adafruit Blog](https://blog.adafruit.com/2021/02/10/circuitpython-6-2-0-beta-2-released/)
...
With MIDI baked into CircuitPython, getting new boards like the Raspberry Pi Pico using this music standard is straightforward. Below are some projects using MIDI from this week.
...
Use of CircuitPython boards as USB HID (Human Interface Device) capable have been appealing to new Raspberry Pi Pico project builders. Meyboards, production keys, and mouse control are all possible with USB HID. Here are some of the projects using HID this past week.
