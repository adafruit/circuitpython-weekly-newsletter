...
Philip Gutjahr was interested in the performance gains that an Adafruit Metro M7 (500MHz) could provide compared to a Raspberry Pi Pico M0+ (125MHz), especially it's hardware acceleration for float operations. Tests in CircuitPython are shown (along with an Intel i7 for giggles) - [Reddit](https://www.reddit.com/r/adafruit/comments/194thhn/metro_m7_vs_pi_pico_vs_intel_cpu_benchmarked/) and results - [GitHub](https://github.com/LaserBorg/circuitpython_benchmark).
