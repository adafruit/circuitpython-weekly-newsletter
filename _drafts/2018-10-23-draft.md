...
AtMakers KeySwitch Housing - The KeySwitch is a low-cost AT Switch Interface to allow a user to send keystrokes and mouse movements by activating external switches - [video](https://www.youtube.com/watch?v=Tr9n-Ne0utA&feature=youtu.be) & [Thingiverse.](https://www.thingiverse.com/thing:3159609)
...
Update to the PewPew FeatherWing - A shield for Adafruit Feather boards with buttons and a LED matrix display, for simple games by ꝺeshipuꝺeshipu - [hackaday.io](https://hackaday.io/project/21578-pewpew-featherwing)
...
[Juno](https://twitter.com/phildini/status/1053399611421802496) - A self-contained mac app for running Jupyter Notebooks. Juno is a desktop app (currently only macOS) that opens Jupyter Notebooks (.ipynb files) as a standalone app. No need to install python, conda, or jupyter. - [GitHub.](https://github.com/phildini/juno)
...
[jobs.adafruit.com](https://jobs.adafruit.com/) has returned and folks are posting their skills (including CircuitPython) and companies are looking for talented makers to join their companies - from Digi-Key, hackaday to Microcenter!
