...
One-shot IR Helper uses a Raspberry Pi Pico as a very simple IR transmitter. Send the code you need based on any trigger you define - [Hackaday](https://hackaday.io/project/186319-one-shot-ir-helper-pi-pico).
