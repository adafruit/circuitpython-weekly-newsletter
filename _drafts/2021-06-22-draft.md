...
What is Embedded Python? Discusses Python on hardware including CircuitPython and MicroPython. It then goes through building a game on a BBC micro:bit - [Real Python](https://realpython.com/embedded-python/).
