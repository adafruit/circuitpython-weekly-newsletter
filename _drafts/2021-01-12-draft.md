...
[![PyPortal Flow Visualizer - tribute to Charles Chuck Yeager](../assets/20210112/20210112-pyportal-flow-visualizer-chuck-yeager-videograb-1-recoloured.jpg)](url)
...
and should run on the [Adafruit PyPortal Titano]() showing subsonic flows (untested)
- [PyPortal Flow Visualizer - Chuck Yeager Text](https://www.youtube.com/watch?v=JajnIi3Lm14) (YouTube).
