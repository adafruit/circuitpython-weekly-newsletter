...
CircuitPython 6.1.0 is the first release candidate for 6.1.x. The release fixes regressions in BLE and FrequencyIn() that prevent these functions from operating properly. The release also includes a considerable speedup in JSON parsing.
