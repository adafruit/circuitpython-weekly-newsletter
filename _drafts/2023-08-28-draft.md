...
Python 3.11.5, 3.10.13, 3.9.18, and 3.8.18 are all now available from python.org. Security and bug fixes, so do upgrade if needed - [Python Insider Blog](https://pythoninsider.blogspot.com/2023/08/python-3115-31013-3918-and-3818-is-now.html).
