---
layout: post
title: "Raspberry Pi Turns 12, PyCon Schedule, KiCad 8 and Much More!"
...
Welcome to the latest Python on Microcontrollers newsletter! The chill of winter appears to be waning and Python news is blooming. Raspberry Pi celebrated 12 years on leap day. PyCon US 2024 talks have been announced with at least three PoH related events. A new verson of KiCad for all your open source PCB design needs. And so much more - I encourage you all to consider answering the Adafruit IO survey below. - *Anne Barela, Ed.*
...
[![US White House Report](../assets/20240304/20240304fed.jpg)](https://pyfound.blogspot.com/2024/02/white-house-recommends-.html)
...
[![CircuitPython Parsec](../assets/20240304/20240304jp.jpg)](https://blog.adafruit.com/2024/03/01/john-parks-circuitpython-parsec-display-buttons-adafruit-circuitpython/)

John Park’s CircuitPython Parsec this week is on Display Buttons - [Adafruit Blog](https://blog.adafruit.com/2024/03/01/john-parks-circuitpython-parsec-display-buttons-adafruit-circuitpython/) and [YouTube](https://youtu.be/4Kl-gWDicek).
...
[![AQI Quality Monitor](../assets/20240304/20240304aqi.jpg)](https://hackaday.io/project/194728-aqi-quality-monitor-v20-pico-w-webserver)

AQI Quality Monitor v2.0 Webserver using a Raspberry Pi Pico W and CircuitPython - [hackaday.io](https://hackaday.io/project/194728-aqi-quality-monitor-v20-pico-w-webserver) and [YouTube](https://youtu.be/8y3oFdj1qZg).
...
[![WiFi-enabled memory stick](../assets/20240304/20240304stick.jpg)](https://www.makerhacks.com/piusb-wifi-memory-stick/)

PiUSB – How to make a WiFi memory stick using a Raspberry Pi Zero W - [Maker Hacks](https://www.makerhacks.com/piusb-wifi-memory-stick/).
