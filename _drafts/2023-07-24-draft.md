...
[Tyrell Desktop Synthesizer](url) from [name](url)

[title](https://learn.adafruit.com/tyrell-desktop-synthesizer) from [John Park](https://learn.adafruit.com/u/johnpark)
