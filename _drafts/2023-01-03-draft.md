...
Python is one of the best programming languages, it can do everything. So hsgw designed an entire keyboard, including the PCB, case, and firmware, using only Python. No need to use Kicad and Fusion360. It is explained on Jupyter Notebook(Google Colaboratory or binder), and it can be customized.
...
See more - [hackaday.io](https://hackaday.io/project/188907-keyboard-as-a-python-code).
