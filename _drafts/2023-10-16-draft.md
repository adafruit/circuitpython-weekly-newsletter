...
text - [site](https://dronebotworkshop.com/pi-pico-circuitpython/).
...
## Project of the Week: A Handheld CircuitPython Computer
...
KeyBoy is a small handheld CircuitPython gaming system using an ESP32-S3 and 1.3" TFT LCD display - [X](https://twitter.com/oakdevtech/status/1711565521672699910).
