...
Developing a changing ambient light behind a TV monitor is a tricky process. Adafruit Playground member CGrover has written a detailed user guide on how he implemented a television ambient light using a AS7341 spectrometer sensor connected to an Adafruit Feather M4 Express board, programmed in CircuitPython - [X thread](https://adafruit-playground.com/u/CGrover/pages/as7341-tv-backlight-proof-of_concept) and [YouTube](https://youtu.be/yFqbalF0FGw).
