...
Python 3.11.3, Python 3.10.11 and 3.12.0 alpha 7 are now available. Alpha 7 is the last alpha verson of Python 3.12 vbefore feature freeze. The other two are bug fixes for existying versions - [Python Insider Blog](https://pythoninsider.blogspot.com/2023/04/its-time-for-another-set-of-python.html).
