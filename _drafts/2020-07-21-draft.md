...
## Can you use Python with Google Maps? Yes, you can

[![Python with Google Maps](../assets/20200721/20200721maps.jpg)](https://github.com/googlemaps/google-maps-services-python)

Did you know there is a Python Client for Google Maps Services? There is! It wouldn't exist but for [Mariatta](https://twitter.com/mariatta) who [posts](https://twitter.com/mariatta/status/1283097901443379200):

> Was trying to find a list of restaurants for future road trip then I thought "why not write the code for doing it?" One thing lead to another and that's how I got a merged pull request in Google Maps Python client library

See Mariatta's [Twitter Post](https://twitter.com/mariatta/status/1283097901443379200) and the API information on [GitHub](https://github.com/googlemaps/google-maps-services-python).
...
A "Hello World" in CircuitPython using NeoPixels and an ADXL335 accelerometer to change the pixel direction according to the accelerometer inclination. Uses the Makerfabs [Maduino Zero](https://www.makerfabs.com/maduino-zero-gprs-gsm-sim800c.html) board - [Twitter](https://twitter.com/N10_SoJu3/status/1283422121251799046). 
