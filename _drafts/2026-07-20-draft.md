---
layout: post
title: "MicroPythin in a Eurorack and on Super Nintendo and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! I found three articles about AI and programming so I made a sprecial section In the News. I didn't want to put it in the top features as this is a Python oriented newsletter and I don't want to put anyone off that we're pivoting towards AI. I do see more folks getting into hardware projects because they have AI as a tool to help them and that's just the thing to expand the user base. 

Some wins for MicroPython this week, being used on a Eurorack module and being ported to Super Nintendo. And if you'd like some Raspberry Pi books, the new Humble Bundle gets you a bunch for a loow price. Happy Monday! - *Anne Barela, Editor*
...
A Raspberry Pi Pico 2W + 2.13 inch e-paper HAT WiFi name badge running MicroPython that stays readable with near-zero idle powert - [ShillehTek](https://shillehtek.com/blogs/news/raspberry-pi-pico-2w-e-paper-wifi-name-badge).
