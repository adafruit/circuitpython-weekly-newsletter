---
layout: post
title: "MicroPython in a Eurorack and on Super Nintendo, Plus More!"
...
Some wins for MicroPython this week, being used on a Eurorack module and being ported to Super Nintendo. And if you'd like some Raspberry Pi books, the new Humble Bundle gets you a bunch for a low price. Happy Monday! - *Anne Barela, Editor*
...
[![Comparing MicroPython, Zephyr, Lua, and Forth](../assets/20260720/20260720compare.jpg)](https://www.digikey.com/en/maker/blogs/2026/comparing-micropython-zephyr-lua-and-forth)
...
There are multiple ways to build, coordinate, and run AI agents on local machines. Here are seven Python tools to do this - [KDnuggets](https://www.kdnuggets.com/7-python-frameworks-for-orchestrating-local-ai-agents).

## Python's popularity and Third-Party Library Ecosystem Make It an Attractive Target for Threat Actors

[![Attractive Target for Threat Actors](../assets/20260720/20260720sec.jpg)](https://blog.talosintelligence.com/the-serpents-tongue-luring-the-python-out-of-its-den/)
...
[![Deep Dive](../assets/20260720/20260720deepdive.jpg)](https://youtube.com/live/kk9eoJWB0ww)

[Last Friday](https://youtube.com/live/kk9eoJWB0ww), Scott streamed work on Hardware in the Loop software.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20260720/20260720jp.jpg)](https://blog.adafruit.com/2026/07/17/john-parks-circuitpython-parsec-bitmaptools-rotozoom-rotation/)

John Park’s CircuitPython Parsec this week is on `Bitmaptools` Rotozoom Rotation - [Adafruit Blog](https://blog.adafruit.com/2026/07/17/john-parks-circuitpython-parsec-bitmaptools-rotozoom-rotation/) and [YouTube](https://youtu.be/Nu6aA9IRKQs?si=r4zbJrebZgBc2z8C).
...
CircuitPython Weekly Meeting for 7/13 ([notes](https://github.com/adafruit/adafruit-circuitpython-weekly-meeting/blob/main/2026/2026-07-13.md)) [on YouTube](https://youtu.be/7LSWD2pDHOY).
...
[![Adafruit Playground Notes](../assets/20260720/20260720play.jpg)](https://adafruit-playground.com/)
...
Jeff Epler contributes to CircuitPython with two pull requests - [Mastodon](https://mastodon.social/@stylus@social.afront.org/116913038947371069).
...
[![picorescue](../assets/20260720/20260720pico.jpg)](https://github.com/Gadgetoid/picorescue/blob/main/CHANGELOG.md)
...
[![LoRa radio communication devices for Raspberry Pi](../assets/20260720/20260720lora.jpg)](https://www.raspberrypi.com/news/lora-radio-communication-devices-for-raspberry-pi/)

LoRa radio communication devices for Raspberry Pi - [Raspberry Pi News](https://www.raspberrypi.com/news/lora-radio-communication-devices-for-raspberry-pi/).

[![Raspberry Pi 5 IOMMU Driver for Linux](../assets/20260720/20260720pi5.jpg)](https://www.phoronix.com/news/Raspberry-Pi-5-IOMMU-Driver)

Raspberry Pi 5 IOMMU driver being worked on for the mainline Linux kernel - [Raspberry Pi News](https://www.phoronix.com/news/Raspberry-Pi-5-IOMMU-Driver).

[![Wireless macropad](../assets/20260720/20260720macp.jpg)](https://shillehtek.com/blogs/news/raspberry-pi-pico-2w-ble-wireless-macropad-hotkeys)

Wire six mechanical switches to a Raspberry Pi Pico 2W, flash CircuitPython BLE HID, and you have a wireless macropad that fires copy, paste, and mute on Mac, Windows, or Linux - [ShillehTek](https://shillehtek.com/blogs/news/raspberry-pi-pico-2w-ble-wireless-macropad-hotkeys). Via [X](https://x.com/ShillehTek/status/2077869139876573291).

[![Smart Desktop Weather Station](../assets/20260720/20260720smart.jpg)](https://www.youtube.com/watch?v=22LryK9dLRs)

Building a smart desktop weather station with Raspberry Pi Pico 2 W and MicroPython - [YouTube](https://www.youtube.com/watch?v=22LryK9dLRs) and [GitHub](https://github.com/MakerIO-Hub/i-built-a-smart-desktop-weather-station-with-raspberry-pi-pico-2-w).

[![WiFi Name badge](../assets/20260720/20260720badge.jpg)](https://shillehtek.com/blogs/news/raspberry-pi-pico-2w-e-paper-wifi-name-badge)

A Raspberry Pi Pico 2W + 2.13 inch e-paper HAT WiFi name badge running MicroPython that stays readable with near-zero idle power - [ShillehTek](https://shillehtek.com/blogs/news/raspberry-pi-pico-2w-e-paper-wifi-name-badge).
...
[Pick the Perfect Plant: Battery-Powered Sun Tracking](https://learn.adafruit.com/battery-powered-sun-tracking) from [Tyler Cooper](https://learn.adafruit.com/u/tcooper)
...
* [adafruit/Adafruit_CircuitPython_TMP117](https://github.com/adafruit/Adafruit_CircuitPython_TMP117)
...
The next MicroPython Meetup in Melbourne will be on July 22 – [Luma](https://luma.com/micropython). You can see recordings of previous meetings on [YouTube](https://www.youtube.com/@MicroPythonOfficial). June meeting video - [YouTube](https://www.youtube.com/watch?v=lSfzJU0mz_Q&pp=ygULbWljcm9weXRob24%3D).
...
[20260716](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[4,532 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,898 THANKS](../assets/20260720/38kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 38,898 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
