...
Growth is steady and healthy for the project.

The full list of all the CircuitPython libraries contained in the library bundle can be found on the circuitpython.org libraries page - [Adafruit Blog](https://blog.adafruit.com/2022/04/08/350-circuitpython-libraries-circuitpython/).
