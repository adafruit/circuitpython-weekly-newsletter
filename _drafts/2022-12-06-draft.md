...
Interested? See the [guide](https://learn.adafruit.com/circuitpython-on-raspberrypi-linux) on how to use Blinka with supported SBCs (like Raspberry Pi & more) - [Adafruit Blog](https://blog.adafruit.com/2022/11/29/celebrating-100-single-board-computers-that-support-circuitpython-blinka-blinka-circuitpython-sbc-adafruit/).
