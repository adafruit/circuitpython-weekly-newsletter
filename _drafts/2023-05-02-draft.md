---
layout: post
title: "MicroPython v1.20.0 Released, Adafruit Wraps PyCon US and Much More!"
...
[![MicroPython v1.20.0 Released](../assets/20230502/20230502mp.jpg)](https://github.com/micropython/micropython/releases)

MicroPython v1.20.0 has been released and it contains a wide array of improvements and fixes. Of partticular note, it has a new lightweight package manager called mip, which uses a custom protocol to query and install packages that is optimised for embedded systems. It is intended to take over the role of upip and supports installing packages from micropython-lib as well as any URL. The Raspberry Pi Pico W is now supported with WiFi. See all the changes - [GitHub](https://github.com/micropython/micropython/releases).

Also a review from hackster.io - [hackster.io](https://www.hackster.io/news/micropython-1-20-0-launches-with-mip-a-dedicated-package-manager-and-raspberry-pi-pico-w-support-258033aa9d45).
...
[![Deep Dive](../assets/20230502/20230502deepdivet.jpg)](link)
...
[![CircuitPython Parsec](../assets/20230502/20230502jp.jpg)](link)
...
[![title](../assets/20230502/20230502dan.jpg)](https://www.circuitpython.org/)

text - [site](url).

**Kattni**

[![title](../assets/20230502/20230502kattni.jpg)](https://www.circuitpython.org/)

text - [site](url).

**Melissa**

[![title](../assets/20230502/20230502melissa.jpg)](https://www.circuitpython.org/)

text - [site](url).

**Tim**

[![title](../assets/20230502/20230502tim.jpg)](https://www.circuitpython.org/)

text - [site](url).

**Jeff**

[![title](../assets/20230502/20230502jeff.jpg)](https://www.circuitpython.org/)

text - [site](url).

**Scott**

[![title](../assets/20230502/20230502scott.jpg)](https://www.circuitpython.org/)

text - [site](url).

**Liz**

[![title](../assets/20230502/20230502liz.jpg)](https://www.circuitpython.org/)

text - [site](url).

## Upcoming events!

[![PyCon US 2023](../assets/20230502/pycon2023.jpg)](https://us.pycon.org/2023/)
