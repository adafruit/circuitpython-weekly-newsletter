...
[![MicroPython v1.19](../assets/20220628/20220628s3.jpg)](https://arcanesciencelab.wordpress.com/2022/06/20/micropython-v-1-19/)
...
Are you familiar with the [Zen of Python](https://en.wikipedia.org/wiki/Zen_of_Python)? It's codified in [PEP 20](https://peps.python.org/pep-0020/) and it is a simple list of guidelines for writing Python code. There is even a [song](https://blog.adafruit.com/2020/06/02/a-new-song-for-the-zen-of-python-python-pumpichank/) about it - [site](url).
