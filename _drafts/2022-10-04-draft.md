...
CircuitPython wants your Hacktoberfest contributions! We've labeled a number of issues as "hacktoberfest" and the [the full list is on circuitpython.org](https://circuitpython.org/contributing/open-issues?label=hacktoberfest). Your hacktoberfest participation is not limited to these issues, feel free to request a "hacktoberfest-accepted" label for your contribution.

CircuitPython has a number of Open Issues on GitHub tagged Hacktoberfest. See the list - [GitHub](https://circuitpython.org/contributing/open-issues?label=hacktoberfest).
