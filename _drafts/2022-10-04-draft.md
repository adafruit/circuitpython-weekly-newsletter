...
Welcome to the latest Python on Microcontrollers newsletter! October ushers in Hacktoberfest and #ElectronicHalloween with a flurry of activity. A new beta for CircuitPython on the way to a final release. New software arrivals and older software retirement. And some very clever projects, events and more. Enjoy this week's issue.
