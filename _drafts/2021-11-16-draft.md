...
> Join Scott today for an update on Raspberry Pi CircuitPython support and an update on the BLE workflow. Scott will then update circuitpython.org with more info on the BLE workflow. Questions are welcome. This week is on Friday. No stream next week (US Thanksgiving).
