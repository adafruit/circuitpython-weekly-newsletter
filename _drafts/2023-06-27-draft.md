...
Picopad is an open game console that offers a unique opportunity for young tech enthusiasts. It comes as a kit, allowing one to learn the principles of soldering and electronics while building their own games console. In addition, Picopad supports C and MicroPython programming. It's based on the Raspberry Pi RP2040 microcontroller. It has a 2 inch TFT display and a microSD slot - [pajenicko.cz](https://pajenicko.cz/picopad-open-source-herni-konzole) via [Twitter](https://twitter.com/bobricius/status/1671966652701745174).
