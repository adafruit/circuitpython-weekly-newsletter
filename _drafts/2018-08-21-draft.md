...
The aim of this project is to make MicroPython run on FPGAs using the LiteX & Migen+MiSoC technologies... full stack development (FPGA gateware & soft CPU firmware) in Python! - [fupy.github.io](https://fupy.github.io/).
