...
The Python Developer Survey helps the community better understand how Python is used and community trends. We will be closing the survey in about a week so if you have not yet participated in the survey, please do [here](https://surveys.jetbrains.com/s3/c1-python-developers-survey-2021).
...
Using MicroPython and TensorFlow for object tracking on the OpenMV H7 board - [site](https://www.edge-ai-vision.com/2021/11/arm-demonstration-of-real-time-object-tracking-with-openmv/) and [YouTube](https://youtu.be/Jn3gNqgjFMk) via [Twitter](https://twitter.com/ArmSoftwareDev/status/1461707590715518977).
