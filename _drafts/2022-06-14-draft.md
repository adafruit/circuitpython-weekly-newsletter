...
[!CircuitPython 8.0.0 alpha 1](../assets/20220614/20220614cp8.jpg)](CircuitPython 8.0.0 alpha 1)

The CircuitPython teah has released CircuitPython 8.0.0-alpha.1, an alpha version for 8.0.0. It is relatively stable, but there will be further additions and fixes before final release. Note that major number changes, such as version 7 to version 8, may have application programming interface (API) changes that are incompatible with the previous major version - [GitHub](CircuitPython 8.0.0 alpha 1).
...
[![CircuitPython 8 Poster](../assets/20220614/20220614cp8.jpg)](url)

This issue of the newsletter gives subscribers the first look at the official CircuitPython 8 poster! Designed in cooperation with {company}, it shows the CircuitPython togetherness that previous posters like 7 (MicroPython) and 6 (Nordic).
...
[![LED lit vacuum tube](../assets/20220614/20220614led.gif)](https://twitter.com/digitalMakerCIC/status/1535012563091611664)

> "Phil found some old bust Valves and had a wee break from OOP to make a CircuitPython RGB led with a Pimoroni Tiny2040 + 1 button & 1 slide pot for a fun controllable light" - [Twitter](https://twitter.com/digitalMakerCIC/status/1535012563091611664).
...
[![NUMBER THANKS](../assets/20220614/34kdiscord.png)](https://adafru.it/discord)
