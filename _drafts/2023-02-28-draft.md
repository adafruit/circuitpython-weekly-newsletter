...
And Michael Lacock has developed SPI Display GIG Maker, a very simple GIF generator used to generate GIFs that can run in gifio on Circuit Python (currently 8.1.0 Beta) - [GitHub](https://github.com/MichaelLacock/Gif_Maker/tree/main/Gif_Maker).
