---
layout: post
title: "MicroPython v1.29 is Out, Linux on ESP32-S31, MakeCode to MicroPython and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! Happy end of August. And that usually means the beginning of school for students. All those new students learning Python, CircuitPython and MicroPython. And hopefully they'll find the newsletter and get some creative ideas. Creativity can come from anywhere and the maker community is generous with their ideas, designs and code. This week MicroPython has released a major update with many requested features. There is also a new beta for CircuitPython 10.3 to kick the tires. Real Linux on an ESP32? That is what Espressif and a couple of community ports are working on as the new ESP32-S31 has a memory management unit. Do you have some programs made with MakeCode? They can be converted to MicroPython with a bit of guidance. And Raspberry Pi has adopted Cyberdecks and shows the community their reference design. All that and so much more this week. - *Anne Barela, Editor*
...
[![10.3.0-rc.0](../assets/20260831/20260831cp10.jpg)](https://blog.adafruit.com/2026/08/27/circuitpython-10-3-0-rc-0-released/)

CircuitPython 10.3.0-rc.0 is a release candidate for CircuitPython 10.3.0 final. CircuitPython 10.3.0 will be the latest minor revision of CircuitPython, and will be a new stable release - [Adafruit Bloge](https://blog.adafruit.com/2026/08/27/circuitpython-10-3-0-rc-0-released/) and release notes - [GitHub](https://github.com/adafruit/circuitpython/releases/tag/10.3.0-rc.0).
...
* `audiodelays`, `audiofilter`s, and `audiofreeverb` now available on RP2xxx.
...
[![Tod Kurt's CircuitPython Board Viewer](../assets/20260831/20260831board.jpg)](https://todbot.github.io/CircuitPython_BoardViewer/#compare=adafruit_qtpy_esp32s3_nopsram,adafruit_qtpy_esp32c3)

Tod Kurt's CircuitPython board viewer lets you compare CircuitPython compatible boards. For instance, ESP32-S3 vs ESP32-C3 QTPys. S3 has two I2C busses, C3 has a B00T0 button - [GitHub](https://todbot.github.io/CircuitPython_BoardViewer/#compare=adafruit_qtpy_esp32s3_nopsram,adafruit_qtpy_esp32c3). Via [Mastodon](https://mastodon.social/@todbot/117163510416343793).

## Using WebMCP To Interactively Program Hardware

[![Using WebMCP](../assets/20260831/20260831mcp.jpg)](https://x.com/andreban/status/2093060627317113187)

André Bandarra demonstrates adding [WebMCP](https://developer.chrome.com/docs/ai/webmcp) to a website to allow an LLM (ChatGPT in this case) to program a Pimoroni Presto using MicroPython over WebSerial - [X](https://x.com/andreban/status/2093060627317113187).
...
[![Deep Dive](../assets/20260831/20260831deepdive.jpg)](https://youtube.com/live/q2iK3lo-NVM)

[Last Friday](https://youtube.com/live/q2iK3lo-NVM), Scott streamed work on the Zephyr Bootloader.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20260831/20260831jp.jpg)](https://blog.adafruit.com/2026/08/28/john-parks-circuitpython-parsec-fruit-jam-infrared-ir-receiver/)

John Park’s CircuitPython Parsec this week is on the Fruit Jam Infrared IR Receiver - [Adafruit Blog](https://blog.adafruit.com/2026/08/28/john-parks-circuitpython-parsec-fruit-jam-infrared-ir-receiver/) and [YouTube](https://youtu.be/iPLoAQCKNX4?si=VpNCHDVC4BpI8N9b).

Catch all the episodes in the [YouTube playlist](https://www.youtube.com/playlist?list=PLjF7R1fz_OOWFqZfqW9jlvQSIUmwn9lWr).

**Deep Dive with Tim**

[![Deep Dive with Tim](../assets/20260831/20260831timdive.jpg)](https://youtube.com/live/iBs7Ngw_TOw)

[Last week](https://youtube.com/live/iBs7Ngw_TOw), Tim was working on the TE SP-1 CircuitPython Learn Guide.
...
[![Adafruit Playground](../assets/20260831/20260831play.jpg)](https://adafruit-playground.com/)
...
[![Hauntomation: Automating Halloween with Python](../assets/20260831/20260831hallo.jpg)](https://www.mcgurrin.info/robots/50774/)

Hauntomation - automating Halloween with CircuitPython - [The Aspiring Roboticist](https://www.mcgurrin.info/robots/50774/).

[![Jumperless](../assets/20260831/20260831jump.jpg)](https://embedded.fm/episodes/532)

Kevin Santo Cappuccio, founder of Architeuthis Flux, joins Embedded.fm to discuss creating Jumperless, an open-source breadboard that replaces physical jumper wires with software-controlled analog crossbar switches. They explore the need for 445 RGB LEDs on a breadboard, using MicroPython to create scriptable circuits, some of the lessons that can be implemented with the Jumperless, and how it might be used to create new instruments - [embedded.fm](https://embedded.fm/episodes/532).

[![cyd-fb4](../assets/20260831/20260831fb4.gif)](https://github.com/johnlr/cyd-fb4)

The Cheap Yellow Display (CYD) can be clumsy to use from MicroPython since a full framebuffer uses a lot of the available RAM. `cyd-fb4` is a 4-bit framebuffer that leaves enough RAM for programs while still allowing use of a fast FrameBuffer interface - [GitHub](https://github.com/johnlr/cyd-fb4). Via [BlueSky](https://bsky.app/profile/johnlarooy.bsky.social/post/3mtt6k7knyc2z).
...
[![My First Robot Just Got Five New Senses](../assets/20260831/20260831sense.jpg)](https://www.youtube.com/watch?v=1K1A1YGcOEE)

My first robot just got five new senses (Modulino and MicroPython) - [YouTube](https://www.youtube.com/watch?v=1K1A1YGcOEE).

[![Train Countdown Clock](../assets/20260831/20260831train.jpg)](https://github.com/davisonaudio/national-rail-countdown)

The Pimoroni Galactic Unicorn Train Countdown Clock displays national rail train times using MicroPython with the current time and the minutes until the next 3 trains - [GitHub](https://github.com/davisonaudio/national-rail-countdown). Via [BlueSky](https://bsky.app/profile/mdavison.bsky.social/post/3mttjrmbs7s2e).
...
[![Tamagotchi](../assets/20260831/20260831tam.jpg)](https://www.youtube.com/watch?v=udwHpw4VXUs)

Building a custom MicroPython Tamagotchi from scratch - [YouTube](https://www.youtube.com/watch?v=udwHpw4VXUs).
...
[![synthiota synthesizer kit in CircuitPython](../assets/20260831/20260831synth.jpg)](https://smallrun.net/shop/todbot/synthiota-kit)

The synthiota synthesizer kit in CircuitPython - [SmallRun](https://smallrun.net/shop/todbot/synthiota-kit). Via [BlueSky](https://bsky.app/profile/smallrun.bsky.social/post/3mtthh3ygfm2t).
...
[![OrangePi Zero 4](../assets/20260831/20260831new2.jpg)](https://www.notebookcheck.net/OrangePi-Zero-4-Raspberry-Pi-alternative-comes-with-up-to-16GB-RAM-Wi-Fi-6-and-dual-display-support.1380971.0.html)

The OrangePi Zero 4 is a new compact single-board computer designed as an alternative to comparable Raspberry Pi platforms. Measuring just 2.0 x 2.2 inches, a display can be connected directly rather than only through an interface such as MIPI DSI, and dual-display operation is also supported. A mini HDMI port provides 4K output at 60 FPS. The USB-C port supports video output as well as USB 3.1 data transfers. An Ethernet port is also included. Wireless connectivity consists of Wi-Fi 6 and Bluetooth 5.4. The board is powered by an Allwinner A733 SoC that combines two Cortex-A76 cores with six Cortex-A55 cores. Depending on the model, it comes with up to 16GB of RAM. Optional storage includes up to 32GB of eMMC or up to 128GB of UFS storage, while a microSD card slot is included - [NotebookCheck](https://www.notebookcheck.net/OrangePi-Zero-4-Raspberry-Pi-alternative-comes-with-up-to-16GB-RAM-Wi-Fi-6-and-dual-display-support.1380971.0.html).
...
- [adafruit/Adafruit_CircuitPython_GP8403](https://github.com/adafruit/Adafruit_CircuitPython_GP8403)
- [adafruit/Adafruit_CircuitPython_TAS2505](https://github.com/adafruit/Adafruit_CircuitPython_TAS2505)
- [relic-se/CircuitPython_MenuManager](https://github.com/relic-se/CircuitPython_MenuManager)
...
[4,545 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,896 THANKS](../assets/20260831/38kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached 38,896 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
