...
[![The CircuitPython Show](../assets/20260921/cpshow.jpg)](https://circuitpythonshow.com)
...
[![A From-Scratch RP2354A Macro Pad](../assets/20260921/20260921pad.jpg)](https://github.com/Jpwaters09/Macro-Pad)
...
Ben Tasker got a Badgeware Badger — a name badge built around a 2.7″ e-ink display and an RP2350 — and wrote up a getting started guide. It runs MicroPython and mounts as USB mass storage, with everything on it structured as apps (even the menu), so customizing the badge means editing `__init__.py` and dropping in your own assets; most of the post is the debugging that followed, from swapping `rom_font.smart` for a smaller font to a long fight with ImageMagick over why his 16×16 icons wouldn't render – [blog post](https://www.bentasker.co.uk/posts/blog/general/playing-with-an-eink-badge.html).
...
Paulneja got Linux 6.11 running natively on a cheap ESP32-S3 microcontroller, with WiFi, MicroPython and Bash included - [hackster.io](https://www.hackster.io/news/linux-6-11-on-an-esp32-s3-microcontroller-bdbb519203eb).
...
[![ESP32-S3-RLCD-4.2](../assets/20260921/20260921new1.jpg)](https://www.waveshare.com/esp32-s3-rlcd-4.2.htm?sku=33298)

The Waveshare ESP32-S3-RLCD-4.2 is an ESP32-S3 4.2 inch RLCD development board with 300 × 400 resolution. It supports WiFi & BLE dual-mode communication and AI voice interaction - [Waveshare](https://www.waveshare.com/esp32-s3-rlcd-4.2.htm?sku=33298).
...
CircuitPython 10.3.1 adds support for two new boards:
...
I had LLMs research how to save more CircuitPython firmware space. There are some good ideas that would save ~500 bytes to 10k bytes on various builds. Our smallest builds are well optimized and there is not much to cut. I'll be making pull requests for some of those suggestions. I'll also be working on Zephyr.

**Tim**

The pico-faces on Fruit Jam guide is published now. This week I've been shifting gears into Turbo. Learning the differences between native and viper modules, and making some visualization demos. Viper modules can crunch numbers for things like physics simulation very fast. Picogame gives us improved rendering performance, together with viper modules they can create some very fun and snappy games and visualizations. We're only just beginning to scratch the surface of what these new capabilities make possible.
...
I also took a brief detour into optimizing our use of GitHub Actions. We're merging more PRs and needed to improve the Actions backlog. We'll now cancel builds of commits on main when a newer PR is merged. That means we may not have Absolute Newest builds for every commit but the newest one will complete faster.
...
[![MicroPython Meetup](../assets/20260921/20260921mp.png)](https://luma.com/micropython)
...
[![Maker Faire Bay Area](../assets/20260921/20260921mf.jpg)](https://bayarea.makerfaire.com/)
...
[![Adafruit Discord](https://discord.com/api/guilds/327254708534116352/widget.png?style=banner3)](https://discord.gg/adafruit)
