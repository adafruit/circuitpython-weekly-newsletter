...
An RP2040-based Feather with a USB host port. The port is a bit-banged 'fullk-speed' USB Host implementation using TinyUSB - [Twitter](https://twitter.com/adafruit/status/1632366421022744581).
