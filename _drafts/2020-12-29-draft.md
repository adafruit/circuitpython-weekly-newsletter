...
CircuitPython 6.0.1, the second 6.0.x stable release, was made available yesterday. This release fixes regressions in BLE and FrequencyIn() that prevent these functions from operating properly. Note that we recommend the latest pre-release for ESP32-S2 based boards such as the MagTag. The stable release is best for SAMD, STM and nRF boards.
