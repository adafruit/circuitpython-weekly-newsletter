...
CircuitPython 6.0.1, the second 6.0.x stable release. This release fixes regressions in BLE and FrequencyIn() that prevent these functions from operating properly. 
