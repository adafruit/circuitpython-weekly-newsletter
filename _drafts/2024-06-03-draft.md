...
Cheatsheets have proven very popular in the newsletter but findng good ones to highlight is rare. The zine "How git Works" is now available from Wizardzines Julia Evans - [Free Cheatsheet](https://wizardzines.com/git-cheat-sheet.pdf) and [Buy the Zine](https://wizardzines.com/zines/git/) via [X](https://x.com/b0rk/status/1794057694375993704).
...
A new step by step tutorial on how to download and install CircuitPython on the SeeedStudio XIAO RP2040. This is a module by Seeed Studio with Raspberry Pi RP2040 microcontroller - [YouTube](https://www.youtube.com/watch?v=KDb5SQzsGb0).
...
Write Micropython code on tablet instead of PC - [YouTube](https://www.youtube.com/watch?v=L-QPlV3O-4g).
...
RISC-V adoption predicted to get AI boost — forecast shows 50% growth a year through 2030 - [Tom's Hardware](https://www.tomshardware.com/pc-components/cpus/risc-v-adoption-predicted-to-get-ai-boost-forecast-shows-50-growth-every-year-until-2030-for-the-open-standard-isa).
...
PicoShel for CircuitPython - [GitHub](https://github.com/espilab/PicoShell_for_CircuitPython).
