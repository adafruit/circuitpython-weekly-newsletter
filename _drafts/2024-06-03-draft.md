...
Welcome to the latest Python on Microcontrollers newsletter! I thought this might be a quiet week with classes starting to ajourn but then MicroPython drops a huge update on Friday followed by Arduino. I found a cool new cheatsheet on git, don't forget to check out the 'zine that goes with it. And a bumper crop of projects and news from the web, lots to find in this issue. Cheers - *Anne Barela, Editor*
