...
[![06]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 07]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
The PyCon ["Pylife and PyGo"](https://www.kickstarter.com/projects/pycom/pylife-and-pygo-the-most-connected-device-in-the-w) KickStarter is back, this time with a [lower funding threshold](https://pycom.io/why-re-launch-the-pylife-and-pygo-kickstarter/) - [KickStarter.](https://www.kickstarter.com/projects/pycom/pylife-and-pygo-the-most-connected-device-in-the-w)
...
[![ 08]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 09]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 10]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 11]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 12]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 13]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 14]({{ "/assets/" | absolute_url }}){:width="550px"}]()

MIDI FeatherWing.

[![ 15]({{ "/assets/" | absolute_url }}){:width="550px"}]()

nrf52840 Bluefruit Feather runs CircuitPython, has native USB.

## New Learn Guides!

[![ 16]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 17]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![ 18]({{ "/assets/" | absolute_url }}){:width="550px"}]()
...
[![8,8870 thanks 20]({{ "/assets/" | absolute_url }}){:width="550px"}](https://adafru.it/discord)
...
[![ICYMI 21]({{ "/assets/" | absolute_url }}){:width="550px"}]()
