...
Kickstarter project Rotary Encoder aims to bring touch screen rotary encoders to the DIY electronics community. Rotary offers three different variations: Rotary HAT (left), Rotary ESP32 (center), and Rotary Pico W (right) - [All About Circuits](https://www.allaboutcircuits.com/news/rotary-encoder-project-offers-customized-ui-any-mcu-mpu-display/).
