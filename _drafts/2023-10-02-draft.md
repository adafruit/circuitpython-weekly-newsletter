...
Welcome to the latest Python on Microcontrollers newsletter! It's been a few years since the Raspberry Pi 4 was released, so the user base is very excited on this week's information on the Raspberry Pi 5 - *Anne Barela, Ed.*
...
On the heels of the supply shortage easing comes information on the release of the Raspberry Pi 5 - [Raspberry Pi](https://www.raspberrypi.com/products/raspberry-pi-5/).

There are many key features, many requested by the community and enthusiasts for modern computing - [Raspberry Pi Blog](https://www.raspberrypi.com/news/introducing-raspberry-pi-5/) and [YouTube](https://youtu.be/yul4gq_LrOI).
