...
Welcome to the latest Python on Microcontrollers newsletter! Tools have improved for making micirocontroller projects. A new MicroPython editor, updating the third-party online CircuitPython IDE and a nifty free Python script from Adafruit to make pretty script labels in Eagle CAD. Loving the use of RaspberryPi Pico to interface with old keyboards. Some new Python-capable boards and so many projects this week. Enjoy.
