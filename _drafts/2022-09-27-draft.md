...
Mark Komus has a version of CircuitPython installed and running on a custom built ESP-base4d board. "I have an idea for an in home sensor / alarm I can use this for (which was the secondary purpose when designing it - after learning)" - [Twitter](https://twitter.com/MarkKomus/status/1572034052651356161).
