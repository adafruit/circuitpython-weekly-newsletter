...
A simple kitchen timer built with an Adafruit Propmaker RP2040 and a few rotary encoders and seven segment displays. It uses RP2040 deep sleep when not in use, only needing to be charged about once a month - [BlueSky](https://bsky.app/profile/apendley.bsky.social/post/3l74fhl3dcl23).
