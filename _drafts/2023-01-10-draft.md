...
Welcome to the latest Python on Microcontrollers newsletter! The New Year brings new product announcements from Espressif and Raspberry Pi. And promised Raspberry Pi Pico W Bluetooth support. If you have a resolution to learn Python (or learn more about PPython), there are lots of free resources and classes available. And if you want to write Python on Linux, snag a free virtual machine from IBM. Now is the best time to get involved with so many resources available. - *Ed.*
