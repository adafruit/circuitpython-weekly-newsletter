...
Welcome to the latest Python on Microcontrollers newsletter! The ease of use in a language often tracks the number or resources for the language. Besides the documentation and projects for CircuitPython, there is a milestone this week for 400 libraries. Canned routines for drivers and commonly used code is always outstanding. Things are pointing for a decent 2023, things to look forward to - *Ed.*
