...
We will have a lot more updates, stay tuned to the blog, Twitter, Discord, and more!


## Python on Hardware Means Choices for Makers

From Apress ["Python on Hardware Means Choices for Makers"](https://www.apress.com/us/blog/all-blog-posts/python-on-hardware-means-choices-for-makers/16332230) by Liz Clark.
...
[![Mariocart]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/CLirlkh-bsk)

Controlling Mariocart DS with a Circuit Playground Express - [Video](https://youtu.be/CLirlkh-bsk).
