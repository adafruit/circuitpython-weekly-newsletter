...
[![Raspberry Pi 4 Compute Module](/assets/20201016/20201016rpi4cm.jpg)](https://www.raspberrypi.org/blog/raspberry-pi-compute-module-4/)

[![Raspberry Pi 4 CM Connector](/assets/20201016/20201016rpi4cm2.jpg)](https://www.raspberrypi.org/blog/raspberry-pi-compute-module-4/)

The Raspberry Pi 4 COmpute Module was announced Monday. COntaining the same processor as the Raspberry Pi 4, it has various RAM and Flash options (but no on-board expandability). The board breaks from previous modules, coming in a new form factor. I/O signals are brought out to two high-density perpendicular connectors (one for power and low-speed interfaces, and one for high-speed interfaces).

[![Raspberry Pi 4 CM IO Board](/assets/20201016/20201016rpi4cm3.jpg)](https://www.raspberrypi.org/blog/raspberry-pi-compute-module-4/)
...
The next ADABOX ships this month! There are a few openings for ADABOX 16 left! Curated Adafruit products, unique collectibles, and exclusive discounts. All delivered quarterly. Halloween plans have probably changed this year, Halloween is still going to happen! With an ADABOX – learn some new skills and make something fun.
