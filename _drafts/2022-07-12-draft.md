...
A design for HitClip cartridges - [Twitter](https://twitter.com/gvy_dvpont/status/1546176582854868993).
- Work with all of the players that the author owns
- Are easy enough to order/assemble
- Can be configured by end users

Uses:
- A Raspberry Pi RP2040 with CircuitPython
- Solderparty flexypins for programming
