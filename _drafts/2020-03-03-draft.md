...
**This is a 5.0.0 Release Candidate — please test!** This is release 5.0.0-rc.0 (Release candidate 0). If this release does not have show-stopper issues, it will be re-released as 5.0.0, the first 5.x.x stable release. Read more on [the blog post](https://blog.adafruit.com/2020/02/26/circuitpython-5-0-0-release-candidate-0-adafruit-circuitpython/) and download at [circuitpython.org/downloads](https://circuitpython.org/downloads). Hackster also [has some coverage](https://www.hackster.io/news/circuitpython-5-0-0-nears-completion-first-release-candidate-now-available-to-download-ac8b6cf7ef13)!

[![boards](../assets/03032020/3320116boards.jpg)](https://circuitpython.org/downloads)

With the CircuitPython 5.0.0 Release Candidate 0 there are also some new boards in [circuitpython.org/downloads](https://circuitpython.org/downloads), including:
...
[![Stonks](../assets/03032020/)](https://youtu.be/KVpkW4LMaVU)
...
[![WebBle](../assets/03032020/)](https://youtu.be/yJs2y2HMmiw)
...
[![16702 Thanks](../assets/03-03-2020/332016kdiscord.jpg)](https://adafru.it/discord)
