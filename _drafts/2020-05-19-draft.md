...
> What an absolute chonky unit those http://i.MX RT in TQFP 144 variant are. Well that was very easy, flashed @arturo182 TinyUF2 and then @adafruit CircuitPython, which I didn't even have to compile and could just download the uf2 from http://circuitpython.org

best vendor dev board experience without even having touched the vendor tools Smiling face with open mouth and smiling eyes
