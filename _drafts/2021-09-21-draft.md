...
Under the hood, the software uses a Python emulator of the Game Boy More via [joel.franusic](https://joel.franusic.com/playable_quotes_for_game_boy). You can see more about the PyBoy emulator on [GitHub](https://github.com/Baekalfen/PyBoy).
