...
Welcome to the latest Python on Microcontrollers newsletter! There is a lot of new hardware on the scene! If that's your interest, skip to the New section to see what's available plus the new boards supported by CircuitPython. Developers are workinng on Python 3.12 after a successful launch of Python 3.11.  - *Ed.*
