...
We reached out to Profressor Bernhard Boser for some more information about the port and more, here is our interview.
...
Contribute to CircuitPython with Git and GitHub. From fork to merge, this guide covers, we have a [guide](https://learn.adafruit.com/contribute-to-circuitpython-with-git-and-github) and @tannewt [made a video.](https://www.twitch.tv/videos/342402467##)
