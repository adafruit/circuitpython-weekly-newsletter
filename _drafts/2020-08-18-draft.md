...
The source code and design schematics for a simple telescope drive controller for a telescope with basic stepper motor drives. The controller uses an Adafruit M4 Feather Express microntroller and the Adafruit Stepper + DC Motor Feather wing motor drive. The software is written in CircuitPython - [GitHub](https://github.com/Antelope-IT/telescope-controller).
