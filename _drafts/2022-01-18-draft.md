...
Using a Raspberry Pi Pico as a MIDI to CV interface, using a 12-bit ADC (MCP4725). Coded in MicroPython, using @diyelectromusic's SimpleMIDIDecoder class - [Twitter](https://twitter.com/AxWax/status/1482726670561857540).
