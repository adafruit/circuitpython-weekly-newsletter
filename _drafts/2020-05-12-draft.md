...
[Winterbloom](https://winterbloom.com/) is working on a new USB host board in the [FeatherWing format](https://github.com/adafruit/awesome-feather/blob/master/README.md) which will be CircuitPython compatible - [Twitter](https://twitter.com/search?q=hostess%20featherwing&src=typed_query).
