...
See projects tagged #ElectronicHalloween all month for Halloween related projects using Adafruit gear. Adafruit carries all the technology to make Halloween fantastical - [Twitter](https://twitter.com/hashtag/ElectronicHalloween?src=hashtag_click) and [Adafruit Blog](https://blog.adafruit.com/category/halloween/).
