...
CircuitPython BlinkaBot is a fun programmable chatbot where you interface with it using the Bluefruit Connect app (Android & iOS) and communicate with a Circuit Playground Bluefruit microcontroller.
