...
[![alt text]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://youtu.be/_qf6spf090A)
...
It's been a fantastic year for Python on hardware and we appreciate all the support to keep doing this. We're up to 2 years of publishing and over 4,000+ subscribers already, the entire Adafruit team and community thanks you! - [Video](https://youtu.be/_qf6spf090A).
