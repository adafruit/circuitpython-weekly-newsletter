...
[![Happy holidays and thank you from Adafruit 01]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://youtu.be/_qf6spf090A)
...
[![CircuitPython in 2019 02]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2018/12/17/what-do-you-want-from-circuitpython-in-2019-circuitpython2019-circuitpython/)
...
[![HackSpace issue 14 03]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://hackspace.raspberrypi.org/issues/14)

[![HackSpace issue 14 04]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://hackspace.raspberrypi.org/issues/14)
...
[![AR Python 05]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2018/12/19/adafruit-ar-on-the-app-store-adafruit-ar-invoices-apple-arkit/)
...
[![AR Python 06]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2018/12/19/adafruit-ar-on-the-app-store-adafruit-ar-invoices-apple-arkit/)
...
[![Python on Reddit 07]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.reddit.com/r/circuitpython/)
...
[![Kattni 08]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://github.com/kattni/ChiPy_2018)
...
[![Sand Demo 09]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://youtu.be/Eo3Uusr5cV8)
...
[![Stemma 10]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://youtu.be/XE709cB1a6M)
...
[![alt text 11]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/ronhiltz/status/1075212437144698887)
...
[![Block Toys 12]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.instructables.com/id/My-First-Protoboard-Electronics-Block-Toy/)
...
[![Operation 13]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.instagram.com/p/BrrI3JhFWHn/)

A bunch of cool ideas and concepts for custom Operation Games - [Instagram](https://www.instagram.com/p/BrrI3JhFWHn/).

[![Nina 14]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/nnja/status/1074770502449647616?s=11)
...
[![MicroPython 15]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://fahrplan.events.ccc.de/congress/2018/Fahrplan/events/9648.html)
...
[![alt text 16]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://youtu.be/gGqVNuYol6o)
...
[![Subpixel 17]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](http://www.msarnoff.org/millitext/)
...
[![Microsoft Mu 18]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blogs.windows.com/buildingapps/2018/12/19/%e2%80%afintroducing-project-mu/#TmGAW5CwsFqjlpbE.97)
...
[![turtle 19]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/ntoll/status/1054824016475762689)
...
[![NRF52840 20]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/product/4062)

[![NRF52840 21]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](hhttps://www.adafruit.com/product/4062)

[Adafruit NRF52840](https://www.adafruit.com/product/4062), getting closer!

[![Grand Central 22]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/product/4064)

[Grand Central, tester PCBs](https://www.adafruit.com/product/4064) are in!

## New Learn Guides!

[![Christmas T 23]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/circuit-playground-christmas-tree)
...
[![PyCon]({{ "/assets/image" | absolute_url }}){:width="550px"}](https://us.pycon.org/2019/about/)
...
[![Languages 24]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://github.com/adafruit/circuitpython/issues/1098)
...
[![jobs 25]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://jobs.adafruit.com/job/led-engineer-consultant-needed-for-a-music-video-shoot/)
...
[![Discord 26]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://adafru.it/discord)

The Adafruit Discord community where we do all our CircuitPython development in the open reached over NUMBER humans, thank you! Join today! [https://adafru.it/discord](https://adafru.it/discord) And worth noting, Discord is now reporting over 200 million users! - [Adafruit](https://blog.adafruit.com/2018/12/21/discord-raises-150m-on-2-billion-valuation-has-over-200m-users-discordapp/).

## ICYMI - In case you missed it

[![ICYMI 27]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXRMjM7Sm0J2Xt6H81TdDev)
...
[![2 years 28]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruitdaily.com/category/circuitpython/)
