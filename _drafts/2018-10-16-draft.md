...
A Python based controller for RGB led matrix, running in a Raspberry Pi, uses CircuitPython - [GitHub](https://github.com/flavio-fernandes/bedclock/tree/adafruit), [Show-and-tell](https://youtu.be/2VQixyqWGfE?t=585), & [video.](https://www.youtube.com/watch?v=kgT8Nts2mAI)
...
The idea with this is a book on a CircuitPython-powered device/badge that has a PDF book that teaches code, the device has the book, and the code - and the display shows what is on the device. Future versions could have the IDE too, like mu.
