...
They state that their intentions are twofold: give back to the communities they depend on as well as expand support for open source overall. They state Google firmly believes in open source and its ability to bring together users, contributors, and companies alike to deliver better software - [Google Open Source Blog](https://opensource.googleblog.com/2020/08/open-source-by-numbers-at-google.html).
