...
A tool for exploring JSON APIs interactively. It's also good for pasting in a Mastodon profile link and see the data that is generated - [Mastodon](https://chaos.social/@blinry/109789928987786290) and [json.blinry.org](https://json.blinry.org/).
