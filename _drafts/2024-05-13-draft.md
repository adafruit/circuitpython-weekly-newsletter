...
## The pdated Matter 1.3 Internet of Things Standard Brings Energy Monitoring, Electric Vehicle Charging Support, and More
...
River Wang purchased a drawing robot kit and programmed it using CircuitPython. It processes gcode converted from images to draw images on paper - [YouTube](https://www.youtube.com/watch?v=k056yo-cRJI) via [X](https://twitter.com/River___Wang/status/1786602273398722999?t=RpFMg14gzyCTrjF_3xirHQ&s=03).
...
CircuitPython NeoPixel BMP animation with Xiao and CircuitPythin - [hackster.io](https://www.hackster.io/nicolaudosbrinquedos/circuitpython-neopixel-bmp-animation-e2ca24).
