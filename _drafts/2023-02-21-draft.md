...
Twitter user Nibble Poker has managed to get a working virtual block-level device working on CircuitPython, where each sector is fetched and written to from a remote host.
