...
NetPi is a solution for your Raspberry Pi Pico's connectivity needs. It's an Ethernet HAT that enables a Pico to connect to the internet. With support for various internet protocols such as TCP, UDP, WOL over UDP, ICMP, IPv4, and more, NetPi can be used to create IoT devices, robots, home automation systems, and industrial control systems - [SB Components](https://shop.sb-components.co.uk/blogs/posts/netpi-ethernet-hat-for-pico-rp2040).
