...
Ladyada is making final tests on the Adafruit Black Lives Matter Board. Shown on Ask an Engineer & Top Secret, this board shows up as a USB flash drive when connected to a computer to hold files, pictures, and CircuitPython code. It has 4 edge-lit LEDs and 4 capacitive touchpads and the iconic symbol on the front. Common alkalyne batteries power this board with a lanyard ring for wearing - [Top Secret](https://youtu.be/Tg-pRtRBCoA?t=48).
...
Yet another programming survey (YAPS): RedMonk's language popularity rankings - Programming language popularity: Python overtakes Java – as Rust reaches top 20
...
Production is up and now is the best time to get the Adafruit items you've been waiting for - [Show Adafruit](https://www.adafruit.com/).
