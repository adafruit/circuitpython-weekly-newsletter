...
CircuitPython 7.3.0 Release Candidate 0 Released. It is considered stable, and is available as a release candidate for testing before the final release of 7.3.0 - [Adafruit Blog](https://blog.adafruit.com/2022/05/15/circuitpython-7-3-0-release-candidate-0-released/) and [GitHub](https://github.com/adafruit/circuitpython/releases/tag/7.3.0-rc.0).
