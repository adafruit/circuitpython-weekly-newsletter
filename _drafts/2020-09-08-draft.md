...
## CircuitPython Day is Tomorrow 9-9-2020!

[![CircuitPython Day: 9-9-2020](../assets/20200908/20200908cpday.jpg)](https://circuitpython.org/)

Tomorrow, September 9, 2020 (9/9/2020), is CircuitPython Day, the day in which Adafruit and the community worldwide celebrate CircuitPython. Happenings and events include a CircuitPython team livestream, collaboration with hardware and software folks, and highlighting all things Python and Python on Hardware.

Hackerlab in Sacramento, California has over 3 hours of virtual events planned for Circuit Python day, everyone is invited.

Details can be found here: https://www.hackerlab.org/en/blog/read/1376035664/hacker-lab-celebrates-circuit-python-day
all times are Pacific.

4:30 PM - Circuit Python FB/YouTube Live Stream Demo of Adafruit devices and Circuit Python programming.
...
[![Lucian](../assets/20200908/20200908lucian.jpg)](https://circuitpython.org/)
...
[1818 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
