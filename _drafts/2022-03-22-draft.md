...
Sensor Playgrounnd keeps track of indoor air quality through the cloud.It supports either an ESP32 DevKit or an Adafruit Feather module to provide processing power, and provides sockets for a bunch of sensors, conveniently wired with power and SPI or I2C. - [Hackaday](https://hackaday.com/2022/03/19/sensor-playground-keeps-track-of-indoor-air-quality-through-the-cloud/) and [Hackaday.io](https://hackaday.io/project/182619-sensor-playground), and [GitHub](https://github.com/tdwgithub/sensor-playground).
