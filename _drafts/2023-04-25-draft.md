...
Welcome to the latest Python on Microcontrollers newsletter! The big news this week is the Python convention in Salt Lake City. It seems like many in the community are there and therefore not as much news is being released. Adafruit has been sponsoring Open Spaces and is currently hosting Sprints, if you are there, look them up! The next to PyCon US events will be in '24 and '25, both in Pittsburgh, Pennsylvania, US. - *Ed.*
