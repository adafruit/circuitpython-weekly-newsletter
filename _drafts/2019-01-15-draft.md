...
## CircuitPython snakes its way on the SparkFun SAMD21 Mini
...
Sophy Wong has some sneak peeks of a Circuit Python light painting glove for [HackSpace Magazine](https://hackspace.raspberrypi.org/) captured in-camera with a long exposure and hand held flash. You can do a lot with just one NeoPixel! - [Twitter](https://twitter.com/sophywong/status/1083806575725240320).
