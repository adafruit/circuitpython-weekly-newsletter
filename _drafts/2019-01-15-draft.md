...
[![Sparkfun SAMD21 Mini]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2019/01/10/circuitpython-on-sparkfun-samd21-mini-by-shawnhymel-adafruit-arduino-circuitpython-sparkfun/)
...
[![10,000]({{ "/assets/" | absolute_url }}){:width="550px"}](https://adafru.it/discord)

The Adafruit Discord community where we do all our CircuitPython development in the open! 

[![10,000]({{ "/assets/" | absolute_url }}){:width="550px"}](https://adafru.it/discord)

Together as a communuty, we reached over 10,000 humans on Sunday 1/13/19 around 11am ET with new human member edian, thank you! Join today! [https://adafru.it/discord](https://adafru.it/discord)

## Tim's CircuitPython magazine spread

[![Tim's CircuitPython magazine spread]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2019/01/12/timothy-garcias-circuitpython-magazine-spread-eighthree/)
...
[![CircuitPython in 2019]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2018/12/17/what-do-you-want-from-circuitpython-in-2019-circuitpython2019-circuitpython/)
...
[![Sophy Wong]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/sophywong/status/1083806575725240320)
...
[![MIDI interface]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/CedarGroveMakr/status/1083955103789309954)
...
[![Dotstar]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/OwainM713/status/1083805407506616322)
...
[![24 hour 180 degree clock]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://youtu.be/iUNTJXLp-Z8)
...
[![IoT Octopus32]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/guido_burger/status/1083084949098561537)
...
[![Crickit and Pi]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.youtube.com/watch?v=ba8LC79woGU)
...
[![Giant Board]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](http://blog.oshpark.com/2019/01/13/giant-board-adafruit-feather-sized-linux/)
...
[![PyBoard Color LCD Skin]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/product/3498)
...
[![CircuitPython for Android]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://hackaday.com/2019/01/10/code-on-your-phone-with-circuitpython-editor/)
...
[![CircuitPython based clock]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/GeekMomProjects/status/1082157266470547456)
...
[![toaruos]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://github.com/klange/toaruos)
...
[![Invent to Learn]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://inventtolearn.com/new-second-edition-of-invent-to-learn-released/)
...
[![Pixelizator]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://github.com/gsurma/pixelizator)
...
[![Space Invaders]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.youtube.com/watch?v=_2yUP3WMDRc)
...
[![Tracking Orangutans with Drones and Gnu-Radio]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://dirkgorissen.com/2019/01/06/wheres-pinoh-tracking-orangutans-with-drones-and-gnu-radio/)
...
[![ICYDNCI]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/product/4064)
...
[![E-Ink Featherwing]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)

E-Ink Featherwing.

[![CircuitPython 4]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/product/4082)

Minor update to the upcoming CircuitPython 4 poster, special thanks to Nordic!

## New Learn Guides!

[![Spinning Disc Step Sequencer]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/spinning-disc-step-sequencer)
...
[![PyPI Download Stats]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/circuitpython-on-raspberrypi-linux/)
