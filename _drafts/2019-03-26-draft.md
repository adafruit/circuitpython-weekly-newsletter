...
Make: Vol. 68 April / May 2019 is here - Guide to Boards! Highlights that include CircuitPyhton, Adafruit boards and more. Cover features: Metro Express, Feather and Circuit Playground, as well as FEATHER-compatible Particle and multiple Linux boards that can run BLINKA (CircuitPython for Linux).
