...
Lastly, they connected the Raspberry Pi Pico W to the Internet and used Adafruit IO, Adafruit's cloud platform for IoT, to graph their data, set up alerts, and create dashboards.
