...
A look at measuring voltages using the Nordic nRF52840-based Adafruit CLUE's analog-to-digital converter (ADC) and CircuitPython, focussed on analysis of noise and software techniques for improving accuracy - [Instructables](https://www.instructables.com/Exploring-and-Reducing-ADC-Noise-on-Adafruit-CLUE-/).
