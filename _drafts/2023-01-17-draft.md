...
The 0xCB Helios is an Elite-C compatible Microcontroller that is based on the RP2040. It’s a drop-in replacement for legacy ProMicro boards - [keeb.supply](https://keeb.supply/products/0xcb-helios).
