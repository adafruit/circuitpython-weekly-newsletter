...
CircuitPython lead developer Scott Shawcroft has been adding a web server to CircuitPython that runs on port 80 and provides workflow related APIs. A goal is to connect to the CircuitPython REPL via a web browser for boards like the ESP32 - [GitHub](https://github.com/adafruit/circuitpython/pull/6528).
