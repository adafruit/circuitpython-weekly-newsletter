...
Welcome to the latest Python on Microcontrollers newsletter! The news has come fast and furious this week. Halloween projects are popping up and are clever. MicroPython v1.24 is about 90% done and may be released soon. Going to GitHub Universe? Your badge is an unannounced MicroPython compatible board. Those and so, so much more. I hope you enjoy this issue. - *Anne Barela, Editor*
