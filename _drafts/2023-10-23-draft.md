...
Welcome to the latest Python on Microcontrollers newsletter! More information is coming out about the Raspberry Pi 5 including benchmarks, documentation and incompatibilities with previous versions. A point release for CircuitPython as the developers are working towards a version 9.0.0 alpha. And you can now post your projects and investigations on the free adafruit-playground.com using the same tools used by Adafruit for over 2600 learning system guides.  - *Anne Barela, Ed.*
