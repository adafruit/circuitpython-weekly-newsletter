...
Bus Pirate 5 firmware v0.1.0 has been released. The new command interface works more like a typical PC command line. Bus syntax (talking to chips) uses a three step compile-run-report process - [X](https://twitter.com/dangerousproto/status/1715301547456844232).
