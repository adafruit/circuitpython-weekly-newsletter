...
A draft copy of the RP1 datasheet is now available from Raspberry Pi with registers and offsets to access various peripherals - [Raspberry Pi](https://datasheets.raspberrypi.com/rp1/rp1-peripherals.pdf).
