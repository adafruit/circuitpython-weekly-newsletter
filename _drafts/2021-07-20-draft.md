...
This past week, I finished up working on a Cat Detector guide. In order to make it more than a big bundle of wires, I designed a single piece 3D-Printable stand for it which turned out great. The Cat Detector uses Machine Learning and Microsoft Lobe to detect cats. You can check out the learn guide at https://learn.adafruit.com/naughty-cat-detector-using-microsoft-lobe. 
