...
Welcome to the latest Python on Microcontrollers newsletter! Now that everyone has settled in for September, we have October and all the Halloween projects, always a favorite. I'm also going to help Adafruit with ShackToberFest where we celebrate Radio Shack through the years. From this week's news and projects, Python on hardware is thriving. - *Anne Barela, Editor*
