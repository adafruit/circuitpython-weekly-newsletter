...
[María José Molina-Contreras](https://twitter.com/MJ_BIO) presenting her solar-powered plant watering system and cute cleaning robots made with a Circuit Playground Express and CircuitPython - [EuroPython](https://ep2021.europython.eu/talks/C5zGPwk-diy-home-automation-with-microcontrollers-and-circuitpython/).
...
[![title](../assets/20210803/2021080-name.jpg)](url)
...
[PicoPew](https://hackaday.io/project/167369-picopew) running [imagiLabs](https://imagilabs.com) code on MicroPython at [EuroPython](https://ep2021.europython.eu/talks/6nMgdHx-creative-coding-with-imagilabs/) - [Twitter](https://twitter.com/isziaui/status/1420754882395443209).

(In contrast to their own wearable device, [imagiCharm](https://imagilabs.com/products/imagicharm), which does not run Python on the device but relies on a cloud service.)
