...
Welcome to the latest Python on Microcontrollers newsletter! Your editor is back and extends thanks to Kattni & Paul for their hard work covering in my stead. CircuitPython Day 2023 is on for August 18th, keep an eye out for scheduled activities. CircuitPython 8.2.1 is out with more functionality. Finally I'm looking to keep the shift of newsletters being published Monday mornings (US time) so keep an eye on your inboxes every Monday instead of Tuesday *- Anne Barela, Ed.*
...
The annual CircuitPython Day celebrations have been scheduled for August 18, 2023. Kep an eye on the [Adafruit Blog](https://blog.adafruit.com/) for announcements as well as next week's newsletter.
