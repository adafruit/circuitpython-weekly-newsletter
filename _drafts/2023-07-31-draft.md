...
[![Cerebrum](../assets/20230731/20230731-name.jpg)](https://github.com/jaseg/cerebrum)

Cerebrum is a system building modular firmware images for embedded microcontrollers that can be controlled from a host application connected via an RPC-like protocol on any serial bus - [GitHub](https://github.com/jaseg/cerebrum).
