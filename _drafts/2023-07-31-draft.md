...
CircuitPython 8.2.1 is now the latest bugfix revision of CircuitPython, and is thea new stable release - [Adsafruit Blog](https://blog.adafruit.com/2023/07/25/circuitpython-8-2-1-released/) and [Release Notes](https://github.com/adafruit/circuitpython/releases/tag/8.2.1).
