...
This past week I published a guide on how to solder up some MIDI friends for the QT Py RP2040 (https://learn.adafruit.com/qt-py-rp2040-usb-to-serial-midi-friends). Speaking as someone who ventured into electronics and coding specifically for music tech and MIDI projects, I'm not sure I'll ever get over how straight forward using CircuitPython for MIDI is. 

This coming week I'll be continuing on the laser harp project, some Twitter listener 
CircuitPython code and some new product Learn Guides. I did a guide using the Twitter API back in August 2020 (https://learn.adafruit.com/iot-twitter-listener-party-parrot/overview) and it's been fun to revisit.
