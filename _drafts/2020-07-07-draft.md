...
After [Les Pounder's post](https://bigl.es/tooling-tuesday-get-transport-data/) of using requests + JSON in Python, All About Code tested out a new requests blocks in edublocks to create a simple COVID-19 tracker - [Twitter](https://twitter.com/all_about_code/status/1277954081202614273).
