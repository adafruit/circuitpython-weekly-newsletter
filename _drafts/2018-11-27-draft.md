...
…and then [this different code for a BeagleBone (cause the register map is different).](https://github.com/adafruit/Adafruit_Python_DHT/blob/master/source/Beaglebone_Black/bbb_mmio.c)
...
[![9,000 humans!]({{ "/assets/TK.jpg" | absolute_url }}){:width="550px"}](https://adafru.it/discord)
...
[![ICYMI]({{ "/assets/TK" | absolute_url }}){:width="550px"}](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXRMjM7Sm0J2Xt6H81TdDev)
