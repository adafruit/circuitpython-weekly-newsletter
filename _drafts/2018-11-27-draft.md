---
layout: post
title: "sysfs is dead! long live libgpiod! And A Python powered sound glove ..."
...
[![alt text 00]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://link)
...
[![Hello world 19]({{ "/assets/helloworld550.jpg" | absolute_url }}){:width="550px"}](https://github.com/adafruit/circuitpython/issues/1098)
...
[![jobs.adafruit.com 20]({{ "/assets/19-1120jobs.jpg" | absolute_url }}){:width="550px"}](https://jobs.adafruit.com/)
...
[![9,000 humans! 21]({{ "/assets/TK.jpg" | absolute_url }}){:width="550px"}](https://adafru.it/discord)
...
[![ICYMI 22]({{ "/assets/TK" | absolute_url }}){:width="550px"}](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXRMjM7Sm0J2Xt6H81TdDev)
