...
[![LumiDrive]({{ "/assets/" | absolute_url }}){:width="550px"}](https://learn.sparkfun.com/tutorials/lumidrive-hookup-guide)
...
[![CircuitPython 2019]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/?s=%23circuitpython2019)
...
[![Twitter bot]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/r9AXgc59if4)
...
[![alt text]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://twitter.com/OwainM713/status/1086678388993978368)
...
[![microbit mag issue 3]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://micromag.cc/issuethree/)
...
[![GPIOzero]({{ "/assets/" | absolute_url }}){:width="550px"}](https://twitter.com/gvanrossum/status/1085770388125011971)
...
[![Sipeed Maix]({{ "/assets/" | absolute_url }}){:width="550px"}](https://robotzero.one/sipeed-maix-micropython/)
...
[![wii micropython]({{ "/assets/" | absolute_url }}){:width="550px"}](https://arduino103.blogspot.com/2019/01/manette-wii-nunchuck-sous-micropython.html)
...
[![Python on hackster.io]({{ "/assets/" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2019/01/15/python-on-hardware-community-hub-on-hackster-io-hacksterio/)
...
[![JupyterLab]({{ "/assets/" | absolute_url }}){:width="550px"}](https://jupyterlab.readthedocs.io/en/stable/)
...
[![Mu 1.0.2]({{ "/assets/" | absolute_url }}){:width="550px"}](https://madewith.mu/mu/users/2019/01/15/happy-mu-year-2019.html)
...
[![Metro Wifi]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://www.adafruit.com/new)
...
[![hackaday]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://hackaday.io/project/163309-circuitpython-hackaday-portal)
...
[![hackaday]({{ "/assets/image_name" | absolute_url }}){:width="550px"}](https://hackaday.com/2019/01/18/hacking-hackaday-io-from-circuitpython/)
