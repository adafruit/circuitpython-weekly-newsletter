...
[![CircuitPython 7.1.0 Beta 2](../assets/20211207/20211214cp7.jpg)](https://github.com/adafruit/circuitpython/releases)

CircuitPython 7.1.0-beta.2 is available, the third beta release for CircuitPython 7.1.0. It is relatively stable, but contains issues to address for 7.1.0 - [GitHub](https://github.com/adafruit/circuitpython/releases).
