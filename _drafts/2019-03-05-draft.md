...
[![Python on Calculators]({{ "/assets/3519prizmpython1.png" | absolute_url }}){:width="550px"}](https://www.cemetech.net/news.php?id=918)
...
[![Snek]({{ "/assets/3519snek.jpg" | absolute_url }}){:width="550px"}]()
...
We're working on what might be the first IoT "View-Master" project. It uses the PyPortal to retrive images online based on what you want to see, or what someone has suggested you check out. Good for cat photos.
