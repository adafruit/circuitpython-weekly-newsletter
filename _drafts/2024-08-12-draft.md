...
text - [Raspberry Pi News](https://www.raspberrypi.com/news/raspberry-pi-pico-2-our-new-5-microcontroller-board-on-sale-now/), [RP2350 Datasheet](https://datasheets.raspberrypi.com/rp2350/rp2350-datasheet.pdf) (PDF), [Pico 2 Datasheet](https://datasheets.raspberrypi.com/pico/pico-2-datasheet.pdf) (PDF)
...
Both CircuitPython and MicroPython have GitHub Pull Requests (PRs) to their respective codebases to support the RP2350 - [CircuitPython](https://github.com/adafruit/circuitpython/pull/9490) and [MicroPython](https://github.com/micropython/micropython/pull/15619). Look for new builds in the repo Releases sections when the builds are working - [CircuitPython](https://github.com/adafruit/circuitpython/releases) and [MicroPython](https://github.com/micropython/micropython/releases).
...
5 first-rate Linux distros for power users. For advanced users, these distributions are worth the extra bother - [ZDnet](https://www.zdnet.com/article/5-first-rate-linux-distros-for-power-users-or-anyone-seeking-challenge/).
...
[![Bus Pirate 5XL](../assets/20240812/20240812pirate.jpg)](https://x.com/dangerousproto/status/1821562854962528558)

The new Bus Pirate 5XL uses the RP2350A with its upgraded RAM and newer ARM cores, but it's otherwise the same board as 5 - [X](https://x.com/dangerousproto/status/1821562854962528558).
