...
Device provides the status of a lock via a Raspberry Pi Pico W using WiFi via MicroPython. The remote status is on an eInk display - [X](https://twitter.com/sozoraemon/status/1791057996413583444).
