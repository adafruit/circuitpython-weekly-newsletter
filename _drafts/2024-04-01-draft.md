...
Welcome to the latest Python on Microcontrollers newsletter! So much more news this week, which is wonderful! Beagle has a new single board Linux computer aimed at AI. TTwo new versions of CircuitPython were released. Actors hacking in and around PyPI to inject corrupted libraries into programs. That and much more, including many projects for the Raspberry Pi this week. - *Anne Barela, Ed.*
