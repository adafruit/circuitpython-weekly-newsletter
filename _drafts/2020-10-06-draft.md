...
CircuitPython 6.0.0 Beta 1 and Beta 2 were released in the last week. These are the second and third beta releases of CircuitPython 6.0.0. It is relatively stable overall. Beta 1 includes a new canio API, support for the 128x64 OLED and many fixes while Beta 2 features xxx - [Release Notes Beta 1](https://github.com/adafruit/circuitpython/releases/tag/6.0.0-beta.1) - [Release Notes Beta 2](https://github.com/adafruit/circuitpython/releases/tag/6.0.0-beta.2).
