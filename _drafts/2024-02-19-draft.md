...
The OpenMV Cam is a small, low-power microcontroller board to implement applications using machine vision using Python scripts - [Antratek](https://www.antratek.com/openmv-cam-rt).
