...
The Python Software Foundation has a jobs board for people looking for jobs in Python (free account creation required) - [Python.org](https://www.python.org/accounts/login/?next=/jobs/create/).
