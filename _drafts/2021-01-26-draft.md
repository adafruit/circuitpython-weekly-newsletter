...
### Projects using CircuitPython on Pico
...
There is an official guide book, "Get started with MicroPython on Raspberry Pi Pico". Teaches the basics of MicroPython and physical computing, connect your Pico to displays and sensors, build alarms, reaction games, and more - [Raspberry Pi](https://www.raspberrypi.org/documentation/pico/getting-started/).
