...
The new micro:bit editor runs in a browser, so it’s quite different to Thonny or Mu. It appears to be launchiung in September but the beta is online and can be used now - [Twitter Thread](https://twitter.com/4pip/status/1557714643371675650) and [Beta on the Web](https://python.microbit.org/v/beta).
