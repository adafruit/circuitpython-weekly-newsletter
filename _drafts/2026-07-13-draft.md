---
layout: post
title: "CircuitPython and MicroPython IDEs Grow, Kattni Rembor Chairing PyCon US and More!"
date: 2026-07-13 07:00:00 -0800
categories: weekly
---
View this email in your browser. **Warning: Moving Imagery**

Welcome to the latest Python on Microcontrollers newsletter! Well, there certainly have been some interesting World Cup games. I remain neutral, as your editor, but I did live in Europe many years and have a fondness for EU teams. That aside, I was pleased to see River Wang's CircuitPython Online IDE get some nice additions. Not to be outdone, Kevin McAleer added 3D modeling to Snakie, the new MicroPython IDE. Editing Python has never been easier! CircuitPythonista and former backup newsletter editor Kattni has gone from Chairing PyOhio to chairing PyCon US in 2027 (co-chair) and 2028 solo. Congratulations, girl! Raspberry Pi Official Magazine is printing how to install OpenClaw on a Pi 5, that will be very helpful. And much more this busy week, so much so, that I think we all deserve a huge "GOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOAL!!!"- *Anne Barela, Editor*
...
[![Kattni Rembor to Chair PyCon US 2026 and 2027](../assets/20260713/20260713kattni.jpg)](https://pycon.blogspot.com/2026/07/welcome-kattni.html?m=1)
...
Snakie is the new MicroPython development environment which includes coding and making simulations by wiring up virtual boards. In its latest release, You can add STL files into Snakie, join them together and control joint rotation from MicroPython code - [X](https://x.com/kevsmac/status/2075372124538081518) and [Snakie website](https://www.snakie.org/).
...
Simple Python Lithophane Generator - [Adafruit Playground](https://adafruit-playground.com/u/caternuson/pages/simple-python-lithophane-generator).
...
[![CircuitPython Adafruit Fruit Jam GIF video looper](../assets/20260713/20260713relic.jpg)](https://www.youtube.com/watch?v=gCZxLf8eJ-k)
...
[![Flashing MicroPython Firmware on the ESP32-C5_MINI using esptool](../assets/20260713/20260713flash.jpg)](https://www.youtube.com/watch?v=XwxKoOr868s)

Flashing MicroPython firmware on the ESP32-C5_MINI using `esptool` - [YouTube](https://www.youtube.com/watch?v=XwxKoOr868s).
...
[![OpenCV 5 Is Here - The Biggest Update Since 2018](../assets/20260713/20260713cv.jpg)](https://www.youtube.com/watch?v=piHpZWcgQyc)

OpenCV 5 is here - the biggest update since 2018 - [YouTube](https://www.youtube.com/watch?v=piHpZWcgQyc).

[![Micropython on the Pico Computer 3 solving a Sudoku puzzle](../assets/20260713/20260713ss.jpg)](https://www.youtube.com/watch?v=34V2HNlhBfo)

MicroPython on a Pico Computer 3 solving a Sudoku puzzle - [YouTube](https://www.youtube.com/watch?v=34V2HNlhBfo).
...
- [Pcbcupid GLYPH C3 by Pcbcupid](https://circuitpython.org/board/pcbcupid_glyph_c3/)
- [Pcbcupid GLYPH C6 by Pcbcupid](https://circuitpython.org/board/pcbcupid_glyph_c6/)
- [Pcbcupid GLYPH H2 by Pcbcupid](https://circuitpython.org/board/pcbcupid_glyph_h2/)
...
[![38,917 THANKS](../assets/20260713/38kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 38,917 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
