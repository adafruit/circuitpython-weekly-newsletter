...
[![edublocks]({{ "/assets/" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/using-edublocks-with-circuit-playground-express?view=all)
...
[![BLE light]({{ "/assets/" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/bluetooth-light-switch-with-crickit-and-nrf52840/overview)
...
[![Pi store]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.youtube.com/watch?v=QLBVAUo586A)
...
[![PyBoardD]({{ "/assets/" | absolute_url }}){:width="550px"}](https://arduino103.blogspot.com/2019/02/pyboard-d-un-nouvelle-carte-micropython.html)
...
[![Method]({{ "/assets/" | absolute_url }}){:width="550px"}](http://www.mouser.com/news/methods/2019-1/mobile/index.html#p=35)

Methods eZine: Design Trends & the Transformation of Everything features Python on hardware this month, including an interview with Ladyada, [page 35](http://www.mouser.com/news/methods/2019-1/mobile/index.html#p=35) - [PDF](http://www.mouser.com/pdfdocs/Mouser-Methods-v3i1.pdf).

## Making games with Python on hardware at FOSDEM and more...

[![FODEM]({{ "/assets/" | absolute_url }}){:width="550px"}](https://fosdem.org/2019/schedule/event/python_games_with_micropython/)
...
[![Space Sophy]({{ "/assets/" | absolute_url }}){:width="550px"}](https://twitter.com/sophywong/status/1093567855117754368)

Sophy's CircuitPython powered space suit - [Twitter](https://twitter.com/sophywong/status/1093567855117754368).

[![TRON]({{ "/assets/" | absolute_url }}){:width="550px"}](https://twitter.com/pvonelling/status/1092992078068498433)
...
[![Maker Update]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/80jJ-Ls_SIE)
...
[![TI]({{ "/assets/" | absolute_url }}){:width="550px"}](https://github.com/adafruit/circuitpython/pull/1527)
...
[![adafruit.io]({{ "/assets/" | absolute_url }}){:width="550px"}](https://blog.adafruit.com/2019/02/08/adafruit-iot-monthly-february-2019-adafruitio-iot/)
...
[![MythBusters Jr]({{ "/assets/" | absolute_url }}){:width="550px"}](https://twitter.com/fede2_cr/status/1093744825701224448)
...
[![3D]({{ "/assets/" | absolute_url }}){:width="550px"}](https://github.com/adafruit/Adafruit_CAD_Parts)
...
[![Zeryth]({{ "/assets/" | absolute_url }}){:width="550px"}](https://www.zerynth.com/blog/python-and-c-hybrid-programming-on-a-microcontroller-with-zerynth/)
...
[![MPbooth]({{ "/assets/" | absolute_url }}){:width="550px"}](https://twitter.com/micropython/status/1093475865462276105)
...
[![Inter]({{ "/assets/" | absolute_url }}){:width="550px"}](https://github.com/rsms/inter)
...
[![Mu screen]({{ "/assets/" | absolute_url }}){:width="550px"}](https://youtu.be/wphN_5oIYS8)
...
[![10,506]({{ "/assets/" | absolute_url }}){:width="550px"}](https://adafru.it/discord)
