...
After close to 9 years, the MicroPython team has decided to close this forum in favour of moving to [GitHub Discussions](https://github.com/orgs/micropython/discussions).
...
- Easier account signup (and for many people who already use GitHub, no new account required at all). - [MicroPython Forum Post](https://forum.micropython.org/viewtopic.php?f=8&t=12971&sid=329429aeedb4a492901c29391b2c14e6) and [GitHub Discussions](https://github.com/orgs/micropython/discussions).
