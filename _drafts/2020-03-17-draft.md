...
My first guide has been published!  ulab: Crunch Numbers fast in CircuitPython.  It has four examples including a way to use light sensor together with a Finite Impulse Response (FIR) filter to measure your pulse on an Adafruit CLUE
