---
layout: post
title: "Made With Mu - A new blog for a great Python editor"
...
[![Made with Mu]({{ "/assets/madewithmu.jpg" | absolute_url }}){:width="550px"}](https://madewith.mu/)
...
[![Socks]({{ "/assets/socks.jpg" | absolute_url }}){:width="550px"}](https://www.sockclub.com/posts/magical_color_machine_sock_design.html)
...
[![MAKE Bundle]({{ "/assets/makebundle.png" | absolute_url }}){:width="550px"}](https://www.humblebundle.com/books/programmable-boards-books)
...
[![Rotary Encoder in CircuitPython]({{ "/assets/rotary.jpg" | absolute_url }}){:width="550px"}](https://learn.adafruit.com/rotary-encoder)
...
[20180621](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest CircuitPython library bundle.
